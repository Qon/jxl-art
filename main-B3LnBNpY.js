if (!self.define) {
  ...
  self.define = (i, o) => {
    ...
    let s = {};
    const a = (e) => n(e, r),
      l = { module: { uri: r }, exports: s, require: a };
    t[r] = Promise.all(i.map((e) => l[e] || a(e))).then((e) => (o(...e), s));
  };
}
define(["require", "./utils-Annl8-x4", "./comlink-0zLmyqPh"], function (
  e,
  t,
  n,
) {
  ...
  class i {
    getCoalesced() {
      if ("getCoalescedEvents" in this.nativePointer) {
        const e = this.nativePointer.getCoalescedEvents().map((e) => new i(e));
    ...
    constructor(e) {
      (this.id = -1),
        ...
        self.Touch && e instanceof Touch
          ...
          : o(e) && (this.id = e.pointerId);
    }
  }
  const o = (e) => "pointerId" in e,
    r = (e) => "changedTouches" in e,
    s = () => {};
  class a {
    stop() {
    ...
    constructor(
      ...
      (this._element = e),
        ...
        (this._pointerStart = (e) => {
          if (o(e) && 0 === e.buttons)
            this._excludeFromButtonsCheck.add(e.pointerId);
          ...
          if (
            ...
            if (o(e)) {
              (e.target && "setPointerCapture" in e.target
                ? e.target
                : this._element
        ...
        (this._touchStart = (e) => {
          for (const t of Array.from(e.changedTouches))
            this._triggerPointerStart(new i(t), e);
        }),
        (this._move = (e) => {
          if (
            !(
              r(e) ||
              (o(e) && this._excludeFromButtonsCheck.has(e.pointerId)) ||
              0 !== e.buttons
            )
          )
            return void this._pointerEnd(e);
          const t = this.currentPointers.slice(),
            n = r(e)
              ? Array.from(e.changedTouches).map((e) => new i(e))
              : [new i(e)],
            s = [];
          for (const e of n) {
            const t = this.currentPointers.findIndex((t) => t.id === e.id);
            -1 !== t && (s.push(e), (this.currentPointers[t] = e));
          }
          0 !== s.length && this._moveCallback(t, s, e);
        }),
        (this._triggerPointerEnd = (e, t) => {
          if (!r(t) && 1 & t.buttons) return !1;
          const n = this.currentPointers.findIndex((t) => t.id === e.id);
          if (-1 === n) return !1;
          this.currentPointers.splice(n, 1),
            this.startPointers.splice(n, 1),
            this._excludeFromButtonsCheck.delete(e.id);
          const i = !(
            "mouseup" === t.type ||
            "touchend" === t.type ||
            "pointerup" === t.type
          );
          return this._endCallback(e, t, i), !0;
        }),
        (this._pointerEnd = (e) => {
          if (this._triggerPointerEnd(new i(e), e))
            if (o(e)) {
        ...
        (this._touchEnd = (e) => {
          for (const t of Array.from(e.changedTouches))
            this._triggerPointerEnd(new i(t), e);
        }),
        (this._startCallback = t),
        (this._moveCallback = n),
        (this._endCallback = a),
        (this._rawUpdates = l && "onpointerrawupdate" in window),
        self.PointerEvent && !c
  ...
  function p() {
    return (
      d || (d = document.createElementNS("http://www.w3.org/2000/svg", "svg"))
    );
  }
  function g() {
  ...
  class v extends HTMLElement {
    ...
    scaleTo(e, t = {}) {
      let { originX: n = 0, originY: i = 0 } = t;
      const { relativeTo: o = "content", allowChangeEvent: r = !1 } = t,
        s = "content" === o ? this._positioningEl : this;
      if (!s || !this._positioningEl)
        return void this.setTransform({ scale: e, allowChangeEvent: r });
      const a = s.getBoundingClientRect();
      if (((n = u(n, a.width)), (i = u(i, a.height)), "content" === o))
        (n += this.x), (i += this.y);
      else {
    ...
    setTransform(e = {}) {
      ...
      let { x: i = this.x, y: o = this.y } = e;
      if (!this._positioningEl) return void this._updateTransform(t, i, o, n);
      const r = this.getBoundingClientRect(),
        s = this._positioningEl.getBoundingClientRect();
      if (!r.width || !r.height) return void this._updateTransform(t, i, o, n);
      let a = f();
      (a.x = s.left - r.left), (a.y = s.top - r.top);
      let l = f();
      (l.x = s.width + a.x), (l.y = s.height + a.y);
      const c = g()
        .translate(i, o)
        .scale(t)
        .multiply(this._transform.inverse());
      (a = a.matrixTransform(c)),
        (l = l.matrixTransform(c)),
        a.x > r.width ? (i += r.width - a.x) : l.x < 0 && (i += -l.x),
        a.y > r.height ? (o += r.height - a.y) : l.y < 0 && (o += -l.y),
        this._updateTransform(t, i, o, n);
    }
    _updateTransform(e, t, n, i) {
      if (
        !(e < this.minScale) &&
    ...
    _onWheel(e) {
      ...
      let { deltaY: n } = e;
      const { ctrlKey: i, deltaMode: o } = e;
      1 === o && (n *= 15);
      const r = 1 - n / (i ? 100 : 300);
      this._applyChange({
        scaleDiff: r,
    ...
    _onPointerMove(e, t) {
      ...
      this._applyChange({
        ...
        originY: s,
        scaleDiff: u,
        panX: o.clientX - i.clientX,
        panY: o.clientY - i.clientY,
        allowChangeEvent: !0,
      });
    }
    _applyChange(e = {}) {
      const {
        ...
        a = g()
          ...
          .translate(-i, -o)
          .scale(this.scale);
      this.setTransform({ allowChangeEvent: s, scale: a.a, x: a.e, y: a.f });
    }
    constructor() {
      super(),
        (this._transform = g()),
      ...
      const e = new a(this, {
        start: (t, n) =>
          !(2 === e.currentPointers.length || !this._positioningEl) &&
          (n.preventDefault(), !0),
        move: (t) => {
  ...
  let y;
  customElements.define("pinch-zoom", v),
    (function () {
      var e = (function () {
        return this;
      })();
      ...
      var t = function (e, n, i) {
        "string" == typeof e
          ? (2 == arguments.length && (i = n),
            t.modules[e] || ((t.payloads[e] = i), (t.modules[e] = null)))
          : t.original
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        String.prototype.startsWith ||
          i(String.prototype, "startsWith", function (e, t) {
            return (t = t || 0), this.lastIndexOf(e, t) === t;
          }),
          String.prototype.endsWith ||
            i(String.prototype, "endsWith", function (e, t) {
              var n = this;
          ...
          String.prototype.repeat ||
            i(String.prototype, "repeat", function (e) {
              for (var t = "", n = this; e > 0; )
                1 & e && (t += n), (e >>= 1) && (n += n);
              return t;
            }),
          String.prototype.includes ||
            i(String.prototype, "includes", function (e, t) {
          ...
          Array.prototype.find ||
            i(Array.prototype, "find", function (e) {
          ...
          Array.prototype.findIndex ||
            i(Array.prototype, "findIndex", function (e) {
              for (var t = this.length, n = arguments[1], i = 0; i < t; i++) {
                var o = this[i];
          ...
          Array.prototype.includes ||
            i(Array.prototype, "includes", function (e, t) {
              return -1 != this.indexOf(e, t);
            }),
          Array.prototype.fill ||
            i(Array.prototype, "fill", function (e) {
              for (
                var t = this,
                  n = t.length >>> 0,
                  i = arguments[1] >> 0,
                  ...
                  r = arguments[2],
                  s = void 0 === r ? n : r >> 0,
                  a = s < 0 ? Math.max(n + s, 0) : Math.min(s, n);
                o < a;
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        (t.isWin = "win" == o),
          ...
          (t.isLinux = "linux" == o),
          (t.isIE =
            "Microsoft Internet Explorer" == s || s.indexOf("MSAppHost") >= 0
              ? parseFloat(
                  (r.match(
          ...
          (t.isSafari =
            (parseFloat(r.split(" Safari/")[1]) && !t.isChrome) || void 0),
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        (t.buildDom = function e(t, n, i) {
          ...
          if (!Array.isArray(t))
            return t && t.appendChild && n && n.appendChild(t), t;
          ...
          var l = document.createElement(t[0]),
            c = t[1],
            h = 1;
          c && "object" == typeof c && !Array.isArray(c) && (h = 2);
          for (s = h; s < t.length; s++) e(t[s], l, i);
          return (
            2 == h &&
        ...
        function a(e, n, o) {
          if ("undefined" != typeof document) {
            ...
            if (!i) {
              var a = o;
              (o && o.getRootNode && (a = o.getRootNode()) && a != o) ||
                (a = document);
        ...
        if (
          ...
          (t.HI_DPI =
            !o.isWin ||
            ("undefined" != typeof window && window.devicePixelRatio >= 1.5)),
          o.isChromeOS && (t.HI_DPI = !1),
              ...
              (o.onload = o.onreadystatechange =
                function (e, n) {
                  (!n &&
                    ...
                    ((o = o.onload = o.onreadystatechange = null), n || t());
                });
          }),
        ...
        (i._emit = i._dispatchEvent =
          function (e, t) {
            ...
            if (n.length || i) {
              ...
              for (
                var s = 0;
                s < n.length && (n[s](t, this), !t.propagationStopped);
                s++
              );
          ...
          a = {
            ...
            setOption: function (e, t) {
              if (this["$" + e] !== t) {
                ...
                if (!n) return l('misspelled option "' + e + '"');
                if (n.forwardTo)
        ...
        var c = (function () {
          ...
          return (
            ...
            (e.prototype.setDefaultValue = function (e, t, n) {
              ...
              i[t] &&
                (i.forwardTo
                  ? this.setDefaultValue(i.forwardTo, t, n)
                  : (i[t].value = n));
            }),
        ...
        (t.setLoader = function (e) {
          ...
          (t.loadModule = function (n, i) {
            ...
            if (Array.isArray(n))
              var s = n[0],
                a = n[1];
            else if ("string" == typeof n) a = n;
            var h = function (n) {
              if (n && !t.$loading[a]) return i && i(n);
              if (
                (t.$loading[a] || (t.$loading[a] = []),
                t.$loading[a].push(i),
                !(t.$loading[a].length > 1))
              ) {
                var r = function () {
                  !(function (t, n) {
                    "ace/theme/textmate" === t || "./theme/textmate" === t
                      ? n(null, e("./theme/textmate"))
                      : l
                        ? l(t, n)
                        : console.error("loader is not configured");
                  })(a, function (e, n) {
                    n && (t.$loaded[a] = n),
                      t._emit("load.module", { name: a, module: n });
                    var i = t.$loading[a];
                    (t.$loading[a] = null),
                ...
                o.loadScript(t.moduleUrl(a, s), r), c();
              }
            };
            if (t.dynamicModules[a])
              t.dynamicModules[a]().then(function (e) {
                e.default ? h(e.default) : h(e);
              });
            else {
              try {
                r = this.$require(a);
      ...
      function (e, t, n) {
        ...
        function r(t) {
          if (o && o.document) {
            i.set(
              "packaged",
              t || e.packaged || n.packaged || (o.define && define.packaged),
            );
            var r = {},
              s = "",
            ...
            a &&
              a.src &&
              (s =
                a.src.split(/[?#]/)[0].split("/").slice(0, -1).join("/") || "");
            for (
              var c, h = l.getElementsByTagName("script"), u = 0;
              u < h.length;
              u++
            ) {
              var d = h[u],
              ...
              if (p) {
                for (var g = d.attributes, f = 0, m = g.length; f < m; f++) {
                  var v = g[f];
                  0 === v.name.indexOf("data-ace-") &&
                    (r[
                      ((c = v.name.replace(/^data-ace-/, "")),
                      c.replace(/-(.)/g, function (e, t) {
            ...
            for (var w in (s && ((r.base = r.base || s), (r.packaged = !0)),
            (r.basePath = r.base),
          ...
          return (
            ...
            (e.prototype.compareRange = function (e) {
              ...
              return 1 == (t = this.compare(n.row, n.column))
                ? 1 == (t = this.compare(i.row, i.column))
                  ? 2
                  : 0 == t
                    ? 1
                    : 0
            ...
            (e.prototype.clipRows = function (t, n) {
              if (this.end.row > n) var i = { row: n + 1, column: 0 };
              else if (this.end.row < t) i = { row: t, column: 0 };
            ...
            (e.prototype.toScreenRange = function (t) {
              ...
              return new e(n.row, n.column, i.row, i.column);
            }),
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        var h = (t.addListener = function (e, t, n, i) {
            e.addEventListener(t, n, l()),
              i && i.$toDestroy.push(new c(e, t, n));
          }),
        ...
        (t.stopEvent = function (e) {
          ...
          (t.capture = function (e, t, n) {
            ...
            return (
              h(i, "mousemove", t), h(i, "mouseup", o), h(i, "dragstart", o), o
            );
          }),
              ...
              function (e) {
                ...
                switch (e.deltaMode) {
                  case e.DOM_DELTA_PIXEL:
                    (e.wheelX = 0.15 * n), (e.wheelY = 0.15 * i);
                    break;
        ...
        if (
            ...
            h(
              ...
              function (e) {
                ...
                var t = (function (e, t, n) {
                  ...
                  if (
                    (n in o.MODIFIER_KEYS && (n = -1),
                    !i &&
                      13 === n &&
                      3 ===
                        (l = "location" in t ? t.location : t.keyLocation) &&
                      (e(t, i, -n), t.defaultPrevented))
                  )
                    return;
                  if (r.isChromeOS && 8 & i) {
                  ...
                  return (
                    !!(i || n in o.FUNCTION_KEYS || n in o.PRINTABLE_KEYS) &&
                    e(t, i, n)
                  );
                })(n, e, e.keyCode);
          ...
          t.nextTick = function (e, n) {
            ...
            var i = "zero-timeout-message-" + g++,
              o = function (r) {
                r.data == i && (t.stopPropagation(r), u(n, "message", o), e());
              };
            h(n, "message", o), n.postMessage(i, "*");
          };
        }
        (t.$idleBlocked = !1),
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        (i = function (e, t) {
          ...
          (this.setNumberOfExtraLines = function (e) {
            ...
            (this.setAriaOptions = function (e) {
              if (
                ...
                e.setLabel &&
                  (n.setAttribute("aria-roledescription", r("editor")),
                  t.session))
              ) {
                var i = t.session.selection.cursor.row;
                n.setAttribute("aria-label", r("Cursor at row $0", [i + 1]));
              }
            }),
            ...
            o.addListener(
              ...
              function (e) {
                if (!S) {
                  ...
                  t.onFocus(e), s.isEdge ? setTimeout(F) : F();
                }
              },
              t,
            ),
            ...
            (this.focus = function () {
              if (
                ...
                x || d || "browser" == this.$focusScroll)
              )
                return n.focus({ preventScroll: !0 });
              var e = n.style.top;
              (n.style.position = "fixed"), (n.style.top = "0px");
              try {
                var i = 0 != n.getBoundingClientRect().top;
              } catch (e) {
                return;
              }
              var o = [];
              if (i)
                for (var r = n.parentElement; r && 1 == r.nodeType; )
                  o.push(r),
                    r.setAttribute("ace_nocontext", "true"),
                    (r =
                      !r.parentElement && r.getRootNode
                        ? r.getRootNode().host
                        : r.parentElement);
          ...
          var I = function (e, n) {
              for (var i = n, o = 1; o <= e - R && o < 2 * E + 1; o++)
                i += t.session.getLine(e - o).length + 1;
              return i;
            },
            F = m
              ? function (e) {
                  if (T && (!i || e) && !$) {
                    e || (e = "");
                    var o = "\n ab" + e + "cde fg\n";
                    o != n.value && (n.value = k = o);
                    var r = 4 + (e.length || (t.selection.isEmpty() ? 0 : 1));
                    (4 == A && L == r) || n.setSelectionRange(4, r),
                      (A = 4),
                      (L = r);
                  }
                }
                      ...
                      a === M + 1
                        ...
                        : a === R - 1
                          ...
                          : (a < R - 1 || a > M + 1) &&
                            ...
                            (M = a > E ? a + E : 2 * E));
                      for (var l = [], c = R; c <= M; c++)
                        l.push(t.session.getLine(c));
                      if (
                        ((o = l.join("\n")),
                        (e = I(s.start.row, s.start.column)),
                        (i = I(s.end.row, s.end.column)),
                        s.start.row < R)
                      ) {
                        var h = t.session.getLine(R - 1);
                        (e = s.start.row < R - 1 ? 0 : e),
                          (i += h.length + 1),
                          (o = h + "\n" + o);
                      } else if (s.end.row > M) {
                        var u = t.session.getLine(M + 1);
                        (i = s.end.row > M + 1 ? u.length : s.end.column),
                          (i += o.length + 1),
                          (o = o + "\n" + u);
                      } else y && a > 0 && ((o = "\n" + o), (i += 1), (e += 1));
                      o.length > p &&
                        (e < p && i < p
                          ...
                          : ((o = "\n"),
                            e == i ? (e = i = 0) : ((e = 0), (i = 1))));
                      var d = o + "\n\n";
                      d != k && ((n.value = k = d), (A = L = d.length));
                    }
                    if (
                      (D && ((A = n.selectionStart), (L = n.selectionEnd)),
                      L != i || A != e || n.selectionEnd != L)
                    )
                      try {
                        n.setSelectionRange(e, i), (A = e), (L = i);
                      } catch (e) {}
                    b = !1;
                  }
                };
          (this.resetSelection = F), T && t.onFocus();
          var O = null;
          ...
          var D = !1,
            ...
            N = function (e) {
              ...
              var i = n.value,
                o = W(i, !0);
              (i.length > 500 || v.test(o) || (y && A < 1 && A == L)) && F();
            },
            H = function (e, t, n) {
              var i = e.clipboardData || window.clipboardData;
              if (i && !h) {
                var o = u || n ? "Text" : "text/plain";
                try {
            ...
            B = function (e, r) {
              var s = t.getCopyText();
              if (!s) return o.preventDefault(e);
              H(e, s)
                ? (m &&
                    (F(s),
                    (i = s),
          ...
          o.addCommandKeyListener(n, t.onCommandKey.bind(t), t),
            o.addListener(
              n,
              "select",
              function (e) {
                b ||
                  (i
                    ...
                    : !(function (e) {
                          return (
                            0 === e.selectionStart &&
                            e.selectionEnd >= k.length &&
                            e.value === k &&
                            k &&
                            e.selectionEnd !== L
                          );
                        })(n)
                      ? y && n.selectionStart != A && F()
                      : (t.selectAll(), F()));
              },
              t,
            ),
            o.addListener(n, "input", N, t),
            o.addListener(n, "cut", P, t),
            o.addListener(n, "copy", z, t),
            o.addListener(n, "paste", V, t),
                  ...
                  W(e),
                    b.markerRange &&
                      ...
                      (b.markerRange.end.column =
                        b.markerRange.start.column + L - b.selectionStart + _));
                }
              }
            },
            K = function (e) {
          ...
          var j,
            Y = l.delayedCall(U, 50).schedule.bind(null, null);
          function q() {
            clearTimeout(j),
              (j = setTimeout(function () {
                x && ((n.style.cssText = x), (x = "")),
          ...
          o.addListener(
              ...
              if (
                ...
                (i.end.row = i.start.row),
                  ...
                  b.useTextareaForIME
                    ? ((k = n.value = ""), (A = 0), (L = 0))
                    : (n.msGetInputContext &&
                        (b.context = n.msGetInputContext()),
                      n.getInputContext && (b.context = n.getInputContext()));
              }
            },
            t,
          ),
            o.addListener(n, "compositionupdate", U, t),
            o.addListener(
              n,
              "keyup",
              function (e) {
            ...
            o.addListener(n, "keydown", Y, t),
            o.addListener(n, "compositionend", K, t),
            ...
            (this.moveToMouse = function (e, i) {
              x || (x = n.style.cssText),
                (n.style.cssText =
                  ...
                  (s.isIE ? "opacity:0.1;" : "") +
                  "text-indent: -" +
                  (A + L) * t.renderer.characterWidth * 0.5 +
                  "px;");
              var r = t.container.getBoundingClientRect(),
                l = a.computedStyle(t.container),
                c = r.top + (parseInt(l.borderTopWidth) || 0),
                h = r.left + (parseInt(r.borderLeftWidth) || 0),
                u = r.bottom - c - n.clientHeight - 2,
                d = function (e) {
                  a.translate(
                    n,
                    e.clientX - h - 2,
                    Math.min(e.clientY - c - 2, u),
                  );
                };
              d(e),
                "mousedown" == e.type &&
                  ...
                  clearTimeout(j),
                  s.isWin && o.capture(t.container, d, q));
            }),
            (this.onContextMenuClose = q);
          var X = function (e) {
            t.textInput.onContextMenu(e), q();
          };
          o.addListener(n, "mouseup", X, t),
            o.addListener(
              n,
              "mousedown",
              function (e) {
            ...
            o.addListener(t.renderer.scroller, "contextmenu", X, t),
            o.addListener(n, "contextmenu", X, t),
            m &&
              (function (e, t, n) {
                var o = null,
                  r = !1;
                ...
                var s = function (e) {
                  if (
                    ...
                    !(r || b || t.$mouseHandler.isMousePressed || i)
                  ) {
                    var o = n.selectionStart,
                      s = n.selectionEnd,
                      a = null,
                        ...
                        : 1 == o
                          ...
                          : s > L && "\n" == k[s]
                            ...
                            : o < A && " " == k[o - 1]
                              ...
                              : o < A || (o == A && L != A && o == s)
                                ? (a = g.left)
                                : s > L && k.slice(0, s).split("\n").length > 2
                                  ? (a = g.down)
                                  : s > L && " " == k[s - 1]
                                    ? ((a = g.right), (l = f.option))
                                    : (s > L || (s == L && L != A && o == s)) &&
                                      (a = g.right),
                      o !== s && (l |= f.shift),
                      a)
                    ) {
                      if (!t.onCommandKey({}, l, a) && t.commands) {
                        a = g.keyCodeToString(a);
                        var c = t.commands.findKeyCommand(l, a);
                        c && t.execCommand(c);
                      }
                      (A = o), (L = s), F("");
                    }
            ...
            return (
              (e.prototype.onMouseDown = function (e) {
                ...
                var o = this.editor,
                  r = e.getButton();
                return 0 !== r
                  ? ((o.getSelectionRange().isEmpty() || 1 == r) &&
                      o.selection.moveToPosition(n),
                    void (
                      2 == r &&
                      (o.textInput.onContextMenu(e.domEvent),
                      i.isMozilla || e.preventDefault())
                    ))
                ...
                if (this.$clickSelection) {
                  ...
                  if (-1 == s && a <= 0)
                    (t = this.$clickSelection.end),
                      (o.end.row == i.row && o.end.column == i.column) ||
                        (i = o.start);
                  else if (1 == a && s >= 0)
                    (t = this.$clickSelection.start),
                      (o.start.row == i.row && o.start.column == i.column) ||
                        (i = o.end);
              ...
              (e.prototype.focusWait = function () {
                var e,
                  ...
                  o =
                    ...
                    (n = this.x),
                    (i = this.y),
                    Math.sqrt(Math.pow(n - e, 2) + Math.pow(i - t, 2))),
                  r = Date.now();
                (o > 0 || r - this.mousedownEvent.time > this.$focusTimeout) &&
              ...
              (e.prototype.onTripleClick = function (e) {
                ...
                i.isMultiLine() && i.contains(t.row, t.column)
              ...
              (e.prototype.onMouseWheel = function (e) {
                if (!e.getAccelKey()) {
                  ...
                  if (
                    ...
                    Math.abs(r) <= 1.5 * Math.abs(n.vx) &&
                    Math.abs(s) <= 1.5 * Math.abs(n.vy)
                      ? ((l = !0), (n.allowed = i))
                      : (n.allowed = 0);
                  }
                  return (
    ...
    ace.define(
      ...
      function (e, t, n) {
        t.preventParentScroll = function (e) {
          ...
          t.scrollHeight > t.clientHeight || e.preventDefault();
        };
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        ...
        e("./lib/event");
        var a = e("./range").Range,
          l = e("./lib/scroll").preventParentScroll,
          c = "ace_tooltip",
          h = (function () {
            function e(e) {
              (this.isOpen = !1),
            ...
            return (
              ...
              (e.prototype.setTheme = function (e) {
                this.$element.className =
                  c + " " + (e.isDark ? "ace_dark " : "") + (e.cssClass || "");
              }),
          ...
          u = new ((function () {
            ...
            return (
              ...
              (e.prototype.removePopup = function (e) {
                ...
                -1 !== t && (this.popups.splice(t, 1), this.updatePopups());
              }),
              (e.prototype.updatePopups = function () {
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var h = ((n = void 0), r(o)), u = h.next();
                        !u.done;
                        u = h.next()
                      ) {
                        var d = u.value;
                        if (this.doPopupsOverlap(d, l)) {
                          c = !1;
                          break;
                        }
                      }
              ...
              (e.prototype.doPopupsOverlap = function (e, t) {
                var n = e.getElement().getBoundingClientRect(),
                  i = t.getElement().getBoundingClientRect();
                return (
                  n.left < i.right &&
                  n.right > i.left &&
                  n.top < i.bottom &&
        ...
        var d = (function (e) {
          function t(t) {
            ...
            return (
              ...
              i.addEventListener("mouseout", n.onMouseOut),
              (i.tabIndex = -1),
              i.addEventListener(
                "blur",
                function () {
                  i.contains(document.activeElement) || this.hide();
                }.bind(n),
              ),
          ...
          return (
            ...
            (t.prototype.onMouseMove = function (e, t) {
              ...
              if (this.isOpen) {
                var i = this.lastEvent && this.lastEvent.getDocumentPosition();
                (this.range &&
                  this.range.contains(i.row, i.column) &&
                  !n &&
            ...
            (t.prototype.isOutsideOfText = function (e) {
              ...
              if (n.column == i.length) {
                var o = t.renderer.pixelToScreenCoordinates(
                    e.clientX,
                    e.clientY,
                  ),
                  r = t.session.documentToScreenPosition(n.row, n.column);
                if (r.column != o.column || r.row != o.row) return !0;
              }
              return !1;
            }),
            ...
            (t.prototype.showForRange = function (e, t, n, i) {
              if (
                !(
                  (i && i != this.lastEvent) ||
                  (this.isOpen && document.activeElement == this.getElement())
                )
              ) {
                var o = e.renderer;
                this.isOpen ||
                  ...
                  (this.range = a.fromPoints(t.start, t.end));
                var r = o.textToScreenCoordinates(t.start.row, t.start.column),
                  s = o.scroller.getBoundingClientRect();
                r.pageX < s.left && (r.pageX = s.left);
                ...
                var c = l.clientHeight,
                  h = l.clientWidth,
                  d = window.innerHeight - r.pageY - o.lineHeight,
                  p = !0;
                r.pageY - c < 0 && r.pageY < d && (p = !1),
                  (l.style.maxHeight = (p ? r.pageY : d) - 10 + "px"),
                  (l.style.top = p ? "" : r.pageY + o.lineHeight + "px"),
                  (l.style.bottom = p
                    ? window.innerHeight - r.pageY + "px"
                    : ""),
                  (l.style.left =
                    Math.min(r.pageX, window.innerWidth - h - 10) + "px");
              }
            }),
            ...
            (t.prototype.hide = function (e) {
              (e || document.activeElement != this.getElement()) &&
                ((e &&
                  e.target &&
                  ("keydown" != e.type || e.ctrlKey || e.metaKey) &&
            ...
            (t.prototype.onMouseOut = function (e) {
              this.timeout &&
                ...
                this.isOpen &&
                  e.relatedTarget &&
                  !this.getElement().contains(e.relatedTarget) &&
                  ((e && e.currentTarget.contains(e.relatedTarget)) ||
                    e.relatedTarget.classList.contains("ace_content") ||
                    this.hide());
            }),
            t
          );
      ...
      function (e, t, n) {
        ...
        t.GutterHandler = function (e) {
          var t,
            n,
            i = e.editor,
            o = i.renderer.$gutterLayer,
            r = new h(i);
          function l() {
            t && (t = clearTimeout(t)),
              r.isOpen && (r.hideTooltip(), i.off("mousewheel", l));
          }
          function c(e) {
          ...
          e.editor.setDefaultHandler("guttermousedown", function (t) {
            if (
              i.isFocused() &&
              0 == t.getButton() &&
              "foldWidgets" != o.getRegion(t)
            ) {
              var n = t.getDocumentPosition().row,
                r = i.session.selection;
              if (t.getShiftKey()) r.selectTo(n, 0);
              else {
                if (2 == t.domEvent.detail)
                  return i.selectAll(), t.preventDefault();
                e.$clickSelection = i.selection.getLineRange(n);
              }
              return (
            ...
            e.editor.setDefaultHandler("guttermousemove", function (a) {
              var h = a.domEvent.target || a.domEvent.srcElement;
              if (s.hasCssClass(h, "ace_fold-widget")) return l();
              r.isOpen && e.$tooltipFollowsMouse && c(a),
                (n = a),
                t ||
                    ...
                    (t = null),
                      n && !e.isMousePressed
                        ? (function () {
                            ...
                            if (t == i.session.getLength()) {
                              var s = i.renderer.pixelToScreenCoordinates(
                                  0,
                                  n.y,
                                ).row,
                                a = n.$pos;
                              if (
                                s >
                                i.session.documentToScreenRow(a.row, a.column)
                              )
                                return l();
                            }
                            if ((r.showTooltip(t), r.isOpen))
                              if (
                                (i.on("mousewheel", l), e.$tooltipFollowsMouse)
                              )
                                c(n);
                              else {
                                var h = n.getGutterRow(),
                                  u = o.$lines.get(h);
                                if (u) {
                                  var d = u.element
                                      .querySelector(".ace_gutter_annotation")
                                      .getBoundingClientRect(),
                                    p = r.getElement().style;
                                  (p.left = d.right + "px"),
                                    (p.top = d.bottom + "px");
                                } else c(n);
                              }
        ...
        var h = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t, "annotationLabels", {
              get: function () {
                return {
                  error: { singular: c("error"), plural: c("errors") },
                  warning: { singular: c("warning"), plural: c("warnings") },
                  info: {
                    singular: c("information message"),
                    plural: c("information messages"),
                  },
                };
              },
              enumerable: !1,
            ...
            (t.prototype.showTooltip = function (e) {
              var n,
                i = this.editor.renderer.$gutterLayer,
                o = i.$annotations[e];
              n = o
                ? { text: Array.from(o.text), type: Array.from(o.type) }
                : { text: [], type: [] };
              var r = i.session.getFoldLine(e);
              if (r && i.$showFoldedAnnotations) {
                for (
                  var s, a = { error: [], warning: [], info: [] }, l = e + 1;
                  l <= r.end.row;
                  l++
                )
                  if (i.$annotations[l])
                    for (var c = 0; c < i.$annotations[l].text.length; c++) {
                      var h = i.$annotations[l].type[c];
                      a[h].push(i.$annotations[l].text[c]),
                        "error" !== h
                          ? "warning" !== h || (s = "warning_fold")
                          : (s = "error_fold");
                    }
                if ("error_fold" === s || "warning_fold" === s) {
                  var u = "".concat(
                    t.annotationsToSummaryString(a),
                    " in folded code.",
                  );
                  n.text.push(u), n.type.push(s);
                }
              }
              if (0 === n.text.length) return this.hide();
              var d = { error: [], warning: [], info: [] },
                p = i.$useSvgGutterIcons ? "ace_icon_svg" : "ace_icon";
              for (l = 0; l < n.text.length; l++) {
                var g = "<span class='ace_"
                  .concat(n.type[l], " ")
                  .concat(p, "' aria-label='")
                  .concat(
                    t.annotationLabels[n.type[l].replace("_fold", "")].singular,
                    "' role=img> </span> ",
                  )
                  .concat(n.text[l]);
                d[n.type[l].replace("_fold", "")].push(g);
              }
              var f = [].concat(d.error, d.warning, d.info).join("<br>");
              this.setHtml(f),
            ...
            (t.annotationsToSummaryString = function (e) {
              ...
              try {
                for (
                  var s = r(["error", "warning", "info"]), a = s.next();
                  !a.done;
                  a = s.next()
                ) {
                  var l = a.value;
                  if (e[l].length) {
                    var c =
                      1 === e[l].length
                        ? t.annotationLabels[l].singular
                        : t.annotationLabels[l].plural;
                    o.push("".concat(e[l].length, " ").concat(c));
                  }
                }
              } catch (e) {
                n = { error: e };
          ...
          r = (function () {
            ...
            return (
              ...
              (e.prototype.getGutterRow = function () {
                ...
                return (
                  this.editor.session.documentToScreenRow(e, 0) -
        ...
        function s(e) {
          ...
          function b() {
            ...
            (function (e, n) {
              ...
              !m || o || r
                ? (t.moveCursorToPosition(e), (m = i), (v = { x: l, y: c }))
                : a(v.x, v.y, l, c) > 5
                  ? (m = null)
                  : i - m >= 200 &&
              ...
              (function (e, n) {
                var i = Date.now(),
                  ...
                  a = {
                    x: { left: l - s.left, right: s.right - l },
                    y: { top: c - s.top, bottom: s.bottom - c },
                  },
                  h = Math.min(a.x.left, a.x.right),
                  u = Math.min(a.y.top, a.y.bottom),
                  d = { row: e.row, column: e.column };
                h / r <= 2 && (d.column += a.x.left < a.x.right ? -3 : 2),
                  u / o <= 1 && (d.row += a.y.top < a.y.bottom ? -1 : 1);
                var p = e.row != d.row,
                  g = e.column != d.column,
                  m = !n || e.row != n.row;
                p || (g && !m)
                  ? f
                    ? i - f >= 200 && t.renderer.scrollCursorIntoView(d)
                    : (f = i)
                  : (f = null);
              })(d, e);
          }
          function $() {
            (u = t.selection.toOrientedRange()),
              ...
              (h = setInterval(b, 20)),
              (w = 0),
              o.addListener(document, "mousemove", S);
          }
          function x() {
            clearInterval(h),
              t.session.removeMarker(s),
              (s = null),
              ...
              (f = null),
              (m = null),
              o.removeListener(document, "mousemove", S);
          }
          (this.onDragStart = function (e) {
            ...
            (o.effectAllowed = t.getReadOnly() ? "copy" : "copyMove"),
              t.container.appendChild(n),
              o.setDragImage && o.setDragImage(n, 0, 0),
              setTimeout(function () {
                t.container.removeChild(n);
              }),
              o.clearData(),
              o.setData("Text", t.session.getTextRange()),
              (g = !0),
              this.setState("drag");
          }),
            (this.onDragEnd = function (e) {
              if (
                ...
                p || "move" != n || t.session.remove(t.getSelectionRange()),
                  t.$resetCursorStyle();
              }
            ...
            (this.onDragEnter = function (e) {
              if (!t.getReadOnly() && k(e.dataTransfer))
                return (
                  ...
                  s || $(),
                  w++,
                  (e.dataTransfer.dropEffect = p = A(e)),
                  o.preventDefault(e)
                );
            }),
            ...
            (this.onDragLeave = function (e) {
              if (--w <= 0 && s) return x(), (p = null), o.preventDefault(e);
            }),
            (this.onDrop = function (e) {
              if (d) {
                ...
                if (g)
                  ...
                  (u = { start: d, end: t.session.insert(d, i) }),
                    t.focus(),
                    (p = null);
                }
                return x(), o.preventDefault(e);
              }
            }),
            o.addListener(y, "dragstart", this.onDragStart.bind(e), t),
            o.addListener(y, "dragend", this.onDragEnd.bind(e), t),
            o.addListener(y, "dragenter", this.onDragEnter.bind(e), t),
            o.addListener(y, "dragover", this.onDragOver.bind(e), t),
            o.addListener(y, "dragleave", this.onDragLeave.bind(e), t),
            o.addListener(y, "drop", this.onDrop.bind(e), t);
          var C = null;
          function S() {
            null == C &&
      ...
      function (e, t, n) {
        ...
        t.addTouchListeners = function (e, t) {
          ...
          function w() {
            var e = window.navigator && window.navigator.clipboard,
              ...
              i = function (i) {
                var o,
                  s,
                  a = i.target.getAttribute("action");
                if ("more" == a || !n)
                  return (
                    (n = !n),
                    (o = t.getCopyText()),
          ...
          function b() {
            ...
            (p.style.top = n.pageY - r.top - 3 + "px"),
              n.pageX - r.left < r.width - 70
                ? ((p.style.left = ""), (p.style.right = "10px"))
                : ((p.style.right = ""),
                  (p.style.left = i + o - r.left + "px")),
              (p.style.display = ""),
              (p.firstChild.style.display = "none"),
              t.on("input", $);
          }
          function $(e) {
            p && (p.style.display = "none"), t.off("input", $);
          }
          function x() {
          ...
          o.addListener(
            ...
            o.addListener(
              ...
              function (e) {
                ...
                var r = t.renderer.layerConfig.lineHeight,
                  h = t.renderer.layerConfig.lineHeight,
                  p = e.timeStamp;
                l = p;
                var w = o[0],
                  b = w.clientX,
                  $ = w.clientY;
                Math.abs(n - b) + Math.abs(s - $) > r && (a = -1),
                  (n = e.clientX = b),
                  (s = e.clientY = $),
                  (v = y = 0);
                var C = new i(e, t);
                if (
                  ...
                  var S = t.selection.cursor,
                    k = t.selection.isEmpty() ? S : t.selection.anchor,
                    ...
                    E = function (e, t) {
                      return (e /= h) * e + (t = t / r - 0.75) * t;
                    };
                  if (e.clientX < _.left) return void (g = "zoom");
                  var T = E(
                      e.clientX - _.left - A.left + M,
                      e.clientY - _.top - A.top + R,
                    ),
                    I = E(
                      e.clientX - _.left - L.left + M,
                      e.clientY - _.top - L.top + R,
                    );
                  T < 3.5 && I < 3.5 && (g = T > I ? "cursor" : "anchor"),
                    (g = I < 3.5 ? "anchor" : T < 3.5 ? "cursor" : "scroll"),
                    (c = setTimeout(x, 450));
                }
                a = p;
              },
              ...
              function (e) {
                (d = t.$mouseHandler.isMousePressed = !1),
                  ...
                  "zoom" == g
                    ? ((g = ""), (f = 0))
                    : c
                      ? (t.selection.moveToPosition(u), (f = 0), b())
                      : "scroll" == g
                        ? ((f += 60),
                          (h = setInterval(function () {
                            f-- <= 0 && (clearInterval(h), (h = null)),
                              Math.abs(v) < 0.01 && (v = 0),
                              Math.abs(y) < 0.01 && (y = 0),
                              f < 20 && (v *= 0.9),
                              f < 20 && (y *= 0.9);
            ...
            o.addListener(
              ...
              function (e) {
                ...
                var o = e.touches;
                if (!(o.length > 1 || "zoom" == g)) {
                  var r = o[0],
                    a = n - r.clientX,
                    h = s - r.clientY;
                  if ("wait" == g) {
                    if (!(a * a + h * h > 4)) return e.preventDefault();
                    g = "cursor";
                  }
                  (n = r.clientX),
                    (s = r.clientY),
                  ...
                  if (((l = u), "scroll" == g)) {
                    ...
                    (p.speed = 1),
                      (p.wheelX = a),
                      (p.wheelY = h),
                      10 * Math.abs(a) < Math.abs(h) && (a = 0),
                      10 * Math.abs(h) < Math.abs(a) && (h = 0),
                      0 != d && ((v = a / d), (y = h / d)),
                      t._emit("mousewheel", p),
                      p.propagationStopped || (v = y = 0);
                  } else {
                    var f = new i(e, t).getDocumentPosition();
                    "cursor" == g
                      ? t.selection.moveCursorToPosition(f)
                      : "anchor" == g &&
                        t.selection.setSelectionAnchor(f.row, f.column),
          ...
          u = (function () {
            function e(e) {
              ...
              i.addListener(
                ...
                i.addListener(a, "mousedown", n, e),
                i.addListener(h, "mousedown", n, e),
                o.isIE &&
                  ...
                  function (n) {
                    if (!t.state && !t.$dragDelay && t.$dragEnabled) {
                      var i = e.renderer.screenToTextCoordinates(n.x, n.y),
                        ...
                        r = e.renderer;
                      !o.isEmpty() && o.insideStart(i.row, i.column)
            ...
            return (
              ...
              (e.prototype.captureMouse = function (e, t) {
                ...
                var s = this,
                  l = function (e) {
                    if (e) {
                      if (o.isWebKit && !e.which && s.releaseMouse)
                  ...
                  c = function (e) {
                    n.off("beforeEndOperation", u),
                      clearInterval(d),
                      n.session && h(),
                      s[s.state + "End"] && s[s.state + "End"](e),
                      (s.state = ""),
                      (s.isMousePressed = r.$isMousePressed = !1),
                ...
                var u = function (e) {
                  s.releaseMouse &&
                    ...
                    (s[s.state + "End"] && s[s.state + "End"](),
                    (s.state = ""),
                    s.releaseMouse());
                };
                n.on("beforeEndOperation", u),
                  n.startOperation({ command: { name: "mouse" } }),
                  (s.$onCaptureMouseMove = l),
                  (s.releaseMouse = i.capture(this.editor.container, l, c));
        ...
        var i = e("../lib/dom"),
          o = function (e) {
            e.on("click", function (t) {
              ...
              r &&
                (t.getAccelKey() ? o.removeFold(r) : o.expandFold(r), t.stop());
              var s = t.domEvent && t.domEvent.target;
              s &&
                i.hasCssClass(s, "ace_inline_button") &&
                i.hasCssClass(s, "ace_toggle_wrap") &&
                (o.setOption("wrap", !o.getUseWrapMode()),
            ...
            return (
              ...
              (e.prototype.setKeyboardHandler = function (e) {
                ...
                if (t[t.length - 1] != e) {
                  for (
                    ;
                    t[t.length - 1] && t[t.length - 1] != this.$defaultHandler;
              ...
              (e.prototype.$callKeyboardHandlers = function (e, t, n, i) {
                for (
                  var r,
                    s = !1,
                  ...
                  !(
                    ...
                    ((s =
                      "null" == r.command ||
                      a.exec(r.command, this.$editor, r.args, i)) &&
                      i &&
                      -1 != e &&
                      1 != r.passEvent &&
                ...
                return (
                  ...
                  s &&
                    this.$editor._signal &&
                    this.$editor._signal("keyboardActivity", r),
                  s
                );
              }),
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        function E(e, t, n) {
          if (!(o < e))
            if (1 != e || 1 != i || s)
              for (var r, a, l, c, h = n.length, u = 0; u < h; ) {
                if (t[u] >= e) {
                  for (r = u + 1; r < h && t[r] >= e; ) r++;
                  for (a = u, l = r - 1; a < l; a++, l--)
                    (c = n[a]), (n[a] = n[l]), (n[l] = c);
                  u = r;
                }
                u++;
          ...
          switch (E) {
            ...
            case w:
              return o < 1 ||
                ...
                : (r && (c = p), c == l ? c : g);
            case b:
              return (l = o > 0 ? n[o - 1] : f) == d &&
                o + 1 < t.length &&
                t[o + 1] == d
                ? d
                : g;
            case $:
              if (o > 0 && n[o - 1] == d) return d;
              if (r) return g;
              for (M = o + 1, R = t.length; M < R && t[M] == $; ) M++;
              return M < R && t[M] == d ? d : g;
            case x:
              for (R = t.length, M = o + 1; M < R && t[M] == x; ) M++;
              if (M < R) {
                var T = e[o],
                  I = (T >= 1425 && T <= 2303) || 64286 == T;
                if (((l = t[M]), I && (l == u || l == v))) return u;
              }
              return o < 1 || (l = t[o - 1]) == f ? g : n[o - 1];
            case f:
              return (r = !1), (s = !0), i;
            case m:
              return (a = !0), g;
        ...
        (t.L = h),
          ...
          (t.RLE = 7),
          (t.DOT = "·"),
          (t.doBidiReorder = function (e, n, h) {
            ...
            (i = h ? 1 : 0),
              (function (e, t, n, h) {
                var u = i ? c : l,
                  ...
                  x = null,
                  C = [];
                if (!h) for ($ = 0, h = []; $ < n; $++) h[$] = I(e[$]);
                for (o = i, r = !1, s = !1, a = !1, x = 0; x < n; x++) {
                  if (
                    ((d = v),
                    (C[x] = p = T(e, h, C, x)),
                    (w = 240 & (v = u[d][p])),
            ...
            for (x = 0; x < w.length - 1; x++)
              n[x] === p
                ? ($[x] = t.AN)
                : $[x] === u &&
                    ((n[x] > v && n[x] < C) || n[x] === g || n[x] === _)
                  ? ($[x] = t.ON_R)
                  : x > 0 &&
                    "ل" === d[x - 1] &&
                    /\u0622|\u0623|\u0625|\u0627/.test(d[x]) &&
                    (($[x - 1] = $[x] = t.R_H), x++);
            d[d.length - 1] === t.DOT && ($[d.length - 1] = t.B),
              "‫" === d[0] && ($[0] = t.RLE);
            for (x = 0; x < w.length; x++) b[x] = $[w[x]];
            return { logicalFromVisual: w, bidiLevels: b };
          }),
          (t.hasBidiCharacters = function (e, t) {
            for (var n = !1, i = 0; i < e.length; i++)
              (t[i] = I(e.charAt(i))),
                n || (t[i] != u && t[i] != v && t[i] != p) || (n = !0);
            return n;
          }),
            ...
            return (
              ...
              (e.prototype.getSplitIndex = function () {
                ...
                if (t.length)
                  for (
                    var n,
                      i = this.session.$getRowCacheIndex(t, this.currentRow);
                    this.currentRow - e > 0 &&
                  ...
                  r &&
                    ...
                    t > 0 && r.length
                      ? ((this.wrapIndent = r.indent),
                        (this.wrapOffset =
                          this.wrapIndent * this.charWidths[i.L]),
                        (this.line =
                          t < r.length
                    ...
                    t == r.length &&
                      (this.line += this.showInvisibles ? n : i.DOT));
                ...
                (this.line = this.line.replace(
                  ...
                  function (e, t) {
                    return "\t" === e || a.isFullWidth(e.charCodeAt(0))
                      ? ((s = "\t" === e ? a.getScreenTabSize(t + l) : 2),
                        (l += s - 1),
                        o.stringRepeat(i.DOT, s))
                      : e;
                  },
                )),
                  this.isRtlDir &&
                    ((this.fontMetrics.$main.textContent =
                      this.line.charAt(this.line.length - 1) == i.DOT
              ...
              (e.prototype.updateBidiMap = function () {
                var e = [];
                i.hasBidiCharacters(this.line, e) || this.isRtlDir
                  ? (this.bidiMap = i.doBidiReorder(
                      this.line,
                      e,
                      this.isRtlDir,
                    ))
              ...
              (e.prototype.updateCharacterWidths = function (e) {
                if (this.characterWidth !== e.$characterSize.width) {
                  ...
                  (this.charWidths[i.L] =
                    this.charWidths[i.EN] =
                    this.charWidths[i.ON_R] =
                      t),
                    (this.charWidths[i.R] = this.charWidths[i.AN] = n),
                    (this.charWidths[i.R_H] = 0.45 * n),
                    (this.charWidths[i.B] = this.charWidths[i.RLE] = 0),
                    (this.currentRow = null);
                }
              }),
              ...
              (e.prototype.setRtlDirection = function (e, t) {
                for (
                  var n = e.getCursorPosition(),
                    i = e.selection.getSelectionAnchor().row;
                  i <= n.row;
                  i++
                )
                  t ||
                  e.session.getLine(i).charAt(0) !== e.session.$bidiHandler.RLE
                    ? t &&
                      e.session.getLine(i).charAt(0) !==
              ...
              (e.prototype.getSelections = function (e, t) {
                var n,
                  ...
                  u = 0;
                this.wrapIndent &&
                  (s += this.isRtlDir ? -1 * this.wrapOffset : this.wrapOffset);
                for (var d, p = 0; p < o.length; p++)
                  (d = i.logicalFromVisual[p]),
                    (n = o[p]),
                    (c = d >= a && d < l) && !h
                      ? (u = s)
                      : !c && h && r.push({ left: u, width: s - u }),
                    (s += this.charWidths[n]),
                    (h = c);
                if (
                  (c && p === o.length && r.push({ left: u, width: s - u }),
                  this.isRtlDir)
                )
    ...
    ace.define(
      ...
      function (e, t, n) {
        var i = e("./lib/oop"),
          ...
          a = (function () {
            ...
            return (
              ...
              (e.prototype.$setSelection = function (e, t, n, i) {
                if (!this.$silent) {
                  var o = this.$isEmpty,
              ...
              (e.prototype.getLineRange = function (e, t) {
                var n,
                  i = "number" == typeof e ? e : this.lead.row,
                  o = this.session.getFoldLine(i);
                return (
                  o ? ((i = o.start.row), (n = o.end.row)) : (n = i),
                  !0 === t
                    ? new s(i, 0, n, this.session.getLine(n).length)
                    : new s(i, 0, n + 1, 0)
                );
              }),
              ...
              (e.prototype.wouldMoveIntoSoftTab = function (e, t, n) {
                var i = e.column,
                  o = e.column + t;
                return (
                  n < 0 && ((i = e.column - t), (o = e.column)),
                  this.session.isTabStop(e) &&
                    this.doc.getLine(e.row).slice(i, o).split(" ").length - 1 ==
                      t
                );
              }),
              (e.prototype.moveCursorLeft = function () {
                ...
                if ((e = this.session.getFoldAt(t.row, t.column, -1)))
                  ...
                  this.wouldMoveIntoSoftTab(t, n, -1) &&
              ...
              (e.prototype.moveCursorLineStart = function () {
                var e = this.lead.row,
                  ...
                  o = this.session
                    .getDisplayLine(e, null, i.row, i.column)
                    .match(/^\s*/);
                o[0].length == t ||
              ...
              (e.prototype.moveCursorBy = function (e, t) {
                var n,
                  i = this.session.documentToScreenPosition(
                    this.lead.row,
                    this.lead.column,
                  );
                if (
                  (0 === t &&
                    (0 !== e &&
                      (this.session.$bidiHandler.isBidiRow(i.row, this.lead.row)
                        ? ((n = this.session.$bidiHandler.getPosLeft(i.column)),
                          (i.column = Math.round(
                            n / this.session.$bidiHandler.charWidths[0],
                          )))
                        : (n =
                            i.column *
                  ...
                  e < 0
                    ? (e -= o.rowsAbove || 0)
                    : e > 0 && (e += o.rowCount - (o.rowsAbove || 0));
                }
        ...
        (a.prototype.setSelectionAnchor = a.prototype.setAnchor),
          (a.prototype.getSelectionAnchor = a.prototype.getAnchor),
          (a.prototype.setSelectionRange = a.prototype.setRange),
          i.implement(a.prototype, r),
          (t.Selection = a);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        var i = e("./lib/report_error").reportError,
          o = 2e3,
          r = (function () {
            function e(e) {
              for (var t in (this.splitRegex,
              (this.states = e),
              (this.regExps = {}),
              (this.matchMappings = {}),
              this.states)) {
                for (
                  ...
                  if (
                    ...
                    c.caseInsensitive && -1 === s.indexOf("i") && (s += "i"),
                    c.unicode && -1 === s.indexOf("u") && (s += "u"),
                    null != c.regex)
                  ) {
              ...
              (e.prototype.getLineTokens = function (e, t) {
                ...
                for (
                  ...
                  var p = s.defaultToken,
                    ...
                    m = a.lastIndex;
                  if (m - f.length > h) {
                    var v = e.substring(h, m - f.length);
                    d.type == p
                      ? (d.value += v)
                      : (d.type && c.push(d), (d = { type: p, value: v }));
                  }
                  for (var y = 0; y < l.length - 2; y++)
                    if (void 0 !== l[y + 1]) {
                      (p = (g = r[s[y]]).onMatch
                        ...
                        g.next &&
                          ((i =
                            "string" == typeof g.next ? g.next : g.next(i, n)),
                          (r = this.states[i]) ||
                          ...
                          (h = m),
                          ((a = this.regExps[i]).lastIndex = m)),
                        g.consumeLineEnd && (h = m);
                      break;
                    }
                  if (f)
                    if ("string" == typeof p)
                      (g && !1 === g.merge) || d.type !== p
                        ? (d.type && c.push(d), (d = { type: p, value: f }))
                        : (d.value += f);
                    else if (p) {
                      d.type && c.push(d), (d = { type: null, value: "" });
                      for (y = 0; y < p.length; y++) c.push(p[y]);
                    }
                  if (h == e.length) break;
                  if (((h = m), u++ > o)) {
                    for (
        ...
        (r.prototype.reportError = i), (t.Tokenizer = r);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        ...
        (function () {
          (this.addRules = function (e, t) {
            ...
            (this.embedRules = function (e, t, n, i, r) {
              ...
              if ((this.addRules(s, t), n)) {
                ...
                for (a = 0; a < i.length; a++) c.apply(this.$rules[i[a]], o(n));
              }
          ...
          (this.normalizeRules = function () {
              ...
              for (var a = 0; a < s.length; a++) {
                ...
                if (
                  ...
                  for (var d in l.rules)
                    i[d]
                      ? i[d].push && i[d].push.apply(i[d], l.rules[d])
                      : (i[d] = l.rules[d]);
            ...
            (this.createKeywordMapper = function (e, t, n, i) {
              ...
              return (
                (this.$keywordList = []),
                Object.keys(e).forEach(function (t) {
                  for (var r = e[t].split(i || "|"), s = r.length; s--; ) {
                    var a = r[s];
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        ((o = function (e) {
          (e = e || {}),
            this.add("braces", "insertion", function (t, n, r, s, a) {
              var c = r.getCursorPosition(),
                h = s.doc.getLine(c.row);
              if ("{" == a) {
                p(r);
                var u = r.getSelectionRange(),
                  d = s.doc.getTextRange(u);
                if ("" !== d && "{" !== d && r.getWrapBehavioursEnabled())
                  return g(u, d, "{", "}");
                if (o.isSaneInsertion(r, s))
                  return /[\]\}\)]/.test(h[c.column]) ||
                    r.inMultiSelectMode ||
                    e.braces
                    ? (o.recordAutoInsert(r, s, "}"),
                      { text: "{}", selection: [1, 1] })
                    : (o.recordMaybeInsert(r, s, "{"),
                      { text: "{", selection: [1, 1] });
              } else if ("}" == a) {
                if ((p(r), "}" == h.substring(c.column, c.column + 1)))
                  if (
                    null !==
                      s.$findOpeningBracket("}", {
                        column: c.column + 1,
                        row: c.row,
                      }) &&
                    o.isAutoInsertedClosing(c, h, a)
                  )
                    return (
                ...
                if ("\n" == a || "\r\n" == a) {
                  ...
                  var f = "";
                  if (
                    (o.isMaybeInsertedClosing(c, h) &&
                      ((f = l.stringRepeat("}", i.maybeInsertedBrackets)),
                      o.clearMaybeInsertedClosing()),
                    "}" === h.substring(c.column, c.column + 1))
                  ) {
                    var m = s.findMatchingBracket(
                      { row: c.row, column: c.column + 1 },
                      "}",
                    );
                    if (!m) return null;
                    var v = this.$getIndent(s.getLine(m.row));
                  } else {
                    if (!f) return void o.clearMaybeInsertedClosing();
                    v = this.$getIndent(h);
                  }
            ...
            this.add("parens", "insertion", function (e, t, n, i, r) {
              if ("(" == r) {
                ...
                if ("" !== a && n.getWrapBehavioursEnabled())
                  return g(s, a, "(", ")");
                if (o.isSaneInsertion(n, i))
                  return (
                    o.recordAutoInsert(n, i, ")"),
                    { text: "()", selection: [1, 1] }
                  );
              } else if (")" == r) {
                p(n);
            ...
            this.add("parens", "deletion", function (e, t, n, i, o) {
              ...
              if (
                ...
                ")" ==
                  i.doc
                    .getLine(o.start.row)
                    .substring(o.start.column + 1, o.start.column + 2))
              )
            ...
            this.add("string_dquotes", "insertion", function (e, t, n, i, o) {
              ...
              if (1 == o.length && r[o]) {
                if (
                  ...
                  -1 != this.lineCommentStart.indexOf(o)
                )
                  return;
                p(n);
                var s = o,
                ...
                if (!l) {
                  var c = n.getCursorPosition(),
                    ...
                    u = h.substring(c.column - 1, c.column),
                    f = h.substring(c.column, c.column + 1),
                    m = i.getTokenAt(c.row, c.column),
                    v = i.getTokenAt(c.row, c.column + 1);
                  if ("\\" == u && m && /escape/.test(m.type)) return null;
                  var y,
                    w = m && /string|escape/.test(m.type),
                    b = !v || /string|escape/.test(v.type);
                  if (f == s)
                    (y = w !== b) && /string\.end/.test(v.type) && (y = !1);
                  else {
                    if (w && !b) return null;
                    if (w && b) return null;
                    var $ = i.$mode.tokenRe;
                    ...
                    $.lastIndex = 0;
                    var C = $.test(f),
                      S = i.$mode.$pairQuotesAfter;
                    if ((!(S && S[s] && S[s].test(u)) && x) || C) return null;
                    if (f && !/[\s;,.})\]\\]/.test(f)) return null;
                    var k = h[c.column - 2];
                    if (u == s && (k == s || $.test(k))) return null;
                    y = !0;
                  }
            ...
            this.add("string_dquotes", "deletion", function (e, t, n, i, o) {
              ...
              if (
                ...
                i.doc
                  .getLine(o.start.row)
                  .substring(o.start.column + 1, o.start.column + 2) == s)
              )
                return o.end.column++, o;
            }),
            !1 !== e.closeDocComment &&
                ...
                function (e, t, n, i, o) {
                  if (
                    ...
                    var r = n.getCursorPosition(),
                      ...
                      a = i.doc.getLine(r.row + 1),
                      l = this.$getIndent(s);
                    if (/\s*\*/.test(a))
                      return /^\s*\*/.test(s)
                        ? {
                            text: o + l + "* ",
                            selection: [1, 3 + l.length, 1, 3 + l.length],
                          }
                        : {
                            text: o + l + " * ",
                            selection: [1, 3 + l.length, 1, 3 + l.length],
                          };
                    if (/\/\*\*/.test(s.substring(0, r.column)))
                      return {
                        text: o + l + " * " + o + " " + l + "*/",
                        selection: [1, 4 + l.length, 1, 4 + l.length],
                      };
                  }
                },
              );
        }).isSaneInsertion = function (e, t) {
          var n = e.getCursorPosition(),
            i = new a(t, n.row, n.column);
          if (!this.$matchTokenType(i.getCurrentToken() || "text", c)) {
            if (/[)}\]]/.test(e.session.getLine(n.row)[n.column])) return !0;
            var o = new a(t, n.row, n.column + 1);
            if (!this.$matchTokenType(o.getCurrentToken() || "text", c))
              return !1;
          }
          return (
            i.stepForward(),
            i.getCurrentTokenRow() !== n.row ||
              this.$matchTokenType(i.getCurrentToken() || "text", h)
          );
        }),
          (o.$matchTokenType = function (e, t) {
            return t.indexOf(e.type || e) > -1;
          }),
          (o.recordAutoInsert = function (e, t, n) {
            var o = e.getCursorPosition(),
              r = t.doc.getLine(o.row);
            this.isAutoInsertedClosing(o, r, i.autoInsertedLineEnd[0]) ||
              (i.autoInsertedBrackets = 0),
              (i.autoInsertedRow = o.row),
              (i.autoInsertedLineEnd = n + r.substr(o.column)),
              i.autoInsertedBrackets++;
          }),
          (o.recordMaybeInsert = function (e, t, n) {
            var o = e.getCursorPosition(),
              r = t.doc.getLine(o.row);
            this.isMaybeInsertedClosing(o, r) || (i.maybeInsertedBrackets = 0),
              (i.maybeInsertedRow = o.row),
              (i.maybeInsertedLineStart = r.substr(0, o.column) + n),
              (i.maybeInsertedLineEnd = r.substr(o.column)),
              i.maybeInsertedBrackets++;
          }),
          (o.isAutoInsertedClosing = function (e, t, n) {
            return (
              i.autoInsertedBrackets > 0 &&
              e.row === i.autoInsertedRow &&
              n === i.autoInsertedLineEnd[0] &&
              t.substr(e.column) === i.autoInsertedLineEnd
            );
          }),
          (o.isMaybeInsertedClosing = function (e, t) {
            return (
              i.maybeInsertedBrackets > 0 &&
              e.row === i.maybeInsertedRow &&
              t.substr(e.column) === i.maybeInsertedLineEnd &&
              t.substr(0, e.column) == i.maybeInsertedLineStart
            );
          }),
    ...
    ace.define(
      ...
      function (e, t, n) {
        for (
          var i = [
              48, 9, 8, 25, 5, 0, 2, 25, 48, 0, 11, 0, 5, 0, 6, 22, 2, 30, 2,
              457, 5, 11, 15, 4, 8, 0, 2, 0, 18, 116, 2, 1, 3, 3, 9, 0, 2, 2, 2,
              0, 2, 19, 2, 82, 2, 138, 2, 4, 3, 155, 12, 37, 3, 0, 8, 38, 10,
              44, 2, 0, 2, 1, 2, 1, 2, 0, 9, 26, 6, 2, 30, 10, 7, 61, 2, 9, 5,
              101, 2, 7, 3, 9, 2, 18, 3, 0, 17, 58, 3, 100, 15, 53, 5, 0, 6, 45,
              211, 57, 3, 18, 2, 5, 3, 11, 3, 9, 2, 1, 7, 6, 2, 2, 2, 7, 3, 1,
              3, 21, 2, 6, 2, 0, 4, 3, 3, 8, 3, 1, 3, 3, 9, 0, 5, 1, 2, 4, 3,
              11, 16, 2, 2, 5, 5, 1, 3, 21, 2, 6, 2, 1, 2, 1, 2, 1, 3, 0, 2, 4,
              5, 1, 3, 2, 4, 0, 8, 3, 2, 0, 8, 15, 12, 2, 2, 8, 2, 2, 2, 21, 2,
              6, 2, 1, 2, 4, 3, 9, 2, 2, 2, 2, 3, 0, 16, 3, 3, 9, 18, 2, 2, 7,
              3, 1, 3, 21, 2, 6, 2, 1, 2, 4, 3, 8, 3, 1, 3, 2, 9, 1, 5, 1, 2, 4,
              3, 9, 2, 0, 17, 1, 2, 5, 4, 2, 2, 3, 4, 1, 2, 0, 2, 1, 4, 1, 4, 2,
              4, 11, 5, 4, 4, 2, 2, 3, 3, 0, 7, 0, 15, 9, 18, 2, 2, 7, 2, 2, 2,
              22, 2, 9, 2, 4, 4, 7, 2, 2, 2, 3, 8, 1, 2, 1, 7, 3, 3, 9, 19, 1,
              2, 7, 2, 2, 2, 22, 2, 9, 2, 4, 3, 8, 2, 2, 2, 3, 8, 1, 8, 0, 2, 3,
              3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2, 15, 4, 7, 2, 2, 2, 3, 10, 0, 9,
              3, 3, 9, 11, 5, 3, 1, 2, 17, 4, 23, 2, 8, 2, 0, 3, 6, 4, 0, 5, 5,
              2, 0, 2, 7, 19, 1, 14, 57, 6, 14, 2, 9, 40, 1, 2, 0, 3, 1, 2, 0,
              3, 0, 7, 3, 2, 6, 2, 2, 2, 0, 2, 0, 3, 1, 2, 12, 2, 2, 3, 4, 2, 0,
              2, 5, 3, 9, 3, 1, 35, 0, 24, 1, 7, 9, 12, 0, 2, 0, 2, 0, 5, 9, 2,
              35, 5, 19, 2, 5, 5, 7, 2, 35, 10, 0, 58, 73, 7, 77, 3, 37, 11, 42,
              2, 0, 4, 328, 2, 3, 3, 6, 2, 0, 2, 3, 3, 40, 2, 3, 3, 32, 2, 3, 3,
              6, 2, 0, 2, 3, 3, 14, 2, 56, 2, 3, 3, 66, 5, 0, 33, 15, 17, 84,
              13, 619, 3, 16, 2, 25, 6, 74, 22, 12, 2, 6, 12, 20, 12, 19, 13,
              12, 2, 2, 2, 1, 13, 51, 3, 29, 4, 0, 5, 1, 3, 9, 34, 2, 3, 9, 7,
              87, 9, 42, 6, 69, 11, 28, 4, 11, 5, 11, 11, 39, 3, 4, 12, 43, 5,
              25, 7, 10, 38, 27, 5, 62, 2, 28, 3, 10, 7, 9, 14, 0, 89, 75, 5, 9,
              18, 8, 13, 42, 4, 11, 71, 55, 9, 9, 4, 48, 83, 2, 2, 30, 14, 230,
              23, 280, 3, 5, 3, 37, 3, 5, 3, 7, 2, 0, 2, 0, 2, 0, 2, 30, 3, 52,
              2, 6, 2, 0, 4, 2, 2, 6, 4, 3, 3, 5, 5, 12, 6, 2, 2, 6, 67, 1, 20,
              0, 29, 0, 14, 0, 17, 4, 60, 12, 5, 0, 4, 11, 18, 0, 5, 0, 3, 9, 2,
              0, 4, 4, 7, 0, 2, 0, 2, 0, 2, 3, 2, 10, 3, 3, 6, 4, 5, 0, 53, 1,
              2684, 46, 2, 46, 2, 132, 7, 6, 15, 37, 11, 53, 10, 0, 17, 22, 10,
              6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 31, 48, 0, 470, 1,
              36, 5, 2, 4, 6, 1, 5, 85, 3, 1, 3, 2, 2, 89, 2, 3, 6, 40, 4, 93,
              18, 23, 57, 15, 513, 6581, 75, 20939, 53, 1164, 68, 45, 3, 268, 4,
              27, 21, 31, 3, 13, 13, 1, 2, 24, 9, 69, 11, 1, 38, 8, 3, 102, 3,
              1, 111, 44, 25, 51, 13, 68, 12, 9, 7, 23, 4, 0, 5, 45, 3, 35, 13,
              28, 4, 64, 15, 10, 39, 54, 10, 13, 3, 9, 7, 22, 4, 1, 5, 66, 25,
              2, 227, 42, 2, 1, 3, 9, 7, 11171, 13, 22, 5, 48, 8453, 301, 3, 61,
              3, 105, 39, 6, 13, 4, 6, 11, 2, 12, 2, 4, 2, 0, 2, 1, 2, 1, 2,
              107, 34, 362, 19, 63, 3, 53, 41, 11, 5, 15, 17, 6, 13, 1, 25, 2,
              33, 4, 2, 134, 20, 9, 8, 25, 5, 0, 2, 25, 12, 88, 4, 5, 3, 5, 3,
              5, 3, 2,
            ],
            o = 0,
            r = [],
        ...
        (function () {
          (this.$defaultBehaviour = new a()),
            ...
            (this.toggleCommentLines = function (e, t, n, i) {
              ...
              if (this.lineCommentStart) {
                if (Array.isArray(this.lineCommentStart))
                  (f = this.lineCommentStart.map(c.escapeRegExp).join("|")),
                    (p = this.lineCommentStart[0]);
                else
                  (f = c.escapeRegExp(this.lineCommentStart)),
                ...
                var u = p + " ",
                  d =
                    ((v = function (e, t) {
                      (r && !/\S/.test(e)) ||
                        (d(e, a, a)
                          ? o.insertInLine({ row: t, column: a }, u)
                          : o.insertInLine({ row: t, column: a }, p));
                    }),
                    (w = function (e, t) {
                      return f.test(e);
                    }),
                ...
                var p = this.blockComment.start,
                  ...
                  m = new RegExp("(?:" + c.escapeRegExp(g) + ")\\s*$"),
                  v = function (e, t) {
                    w(e, t) ||
                      (r && !/\S/.test(e)) ||
                      (o.insertInLine({ row: t, column: e.length }, g),
                      o.insertInLine({ row: t, column: a }, p));
                  },
                  y = function (e, t) {
                    var n;
                    (n = e.match(m)) &&
                      o.removeInLine(t, e.length - n[0].length, e.length),
                      (n = e.match(f)) &&
                        o.removeInLine(t, n[1].length, n[0].length);
                  },
                  w = function (e, n) {
            ...
            (this.toggleBlockComment = function (e, t, n, i) {
              ...
              if (o) {
                !o.start && o[0] && (o = o[0]);
                var r = (f = new h(t, i.row, i.column)).getCurrentToken();
                t.selection;
                var s,
                  a,
                  l = t.selection.toOrientedRange();
                if (r && /comment/.test(r.type)) {
                  for (var c, d; r && /comment/.test(r.type); ) {
                    if (-1 != (m = r.value.indexOf(o.start))) {
                      var p = f.getCurrentTokenRow(),
                        g = f.getCurrentTokenColumn() + m;
                      c = new u(p, g, p, g + o.start.length);
                      break;
                    }
                    r = f.stepBackward();
                  }
                  var f;
                  for (
                    r = (f = new h(t, i.row, i.column)).getCurrentToken();
                    r && /comment/.test(r.type);

                  ) {
                    var m;
                    if (-1 != (m = r.value.indexOf(o.end))) {
                      (p = f.getCurrentTokenRow()),
                        (g = f.getCurrentTokenColumn() + m);
                      d = new u(p, g, p, g + o.end.length);
                      break;
                    }
                    r = f.stepForward();
                  }
                  d && t.remove(d),
                    c &&
                      (t.remove(c), (s = c.start.row), (a = -o.start.length));
                } else
                  (a = o.start.length),
                    (s = n.start.row),
                    t.insert(n.end, o.end),
                    t.insert(n.start, o.start);
                l.start.row == s && (l.start.column += a),
                  l.end.row == s && (l.end.column += a),
            ...
            (this.$delegator = function (e, t, n) {
              ...
              if ("string" != typeof i) {
                if (Array.isArray(i[2])) {
                  ...
                  if ((s = this.$modes[o]))
                    return s[e].apply(s, [i[1]].concat([].slice.call(t, 1)));
                }
                i = i[0] || "start";
              }
              for (var r = 0; r < this.$embeds.length; r++)
                if (this.$modes[this.$embeds[r]]) {
                  ...
                  if (!a[0] && a[1])
                    return (
                      (t[0] = a[1]),
                      (s = this.$modes[this.$embeds[r]])[e].apply(s, t)
                    );
                }
          ...
          switch (t.action) {
            ...
            case "remove":
              var a = t.end.column,
                l = t.end.row;
              i === l
                ? (e[i] = r.substring(0, o) + r.substring(a))
                : e.splice(i, l - i + 1, r.substring(0, o) + e[l].substring(a));
          }
        };
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
                ...
                if (
                  ...
                  var t = (function (e, t, n) {
                    var i = "insert" == e.action,
                      ...
                      a = e.start,
                      l = i ? a : e.end;
                    if (s(t, a, n)) return { row: t.row, column: t.column };
                    if (s(l, t, !n))
                      return {
                        row: t.row + o,
                        column: t.column + (t.row == l.row ? r : 0),
                      };
              ...
              (e.prototype.setPosition = function (e, t, n) {
                ...
                if (
                  ...
                  (this.row = i.row),
                    ...
                    this._signal("change", { old: o, value: i });
                }
              }),
              (e.prototype.detach = function () {
        ...
        (r.prototype.$insertRight = !1),
          i.implement(r.prototype, o),
          (t.Anchor = r);
      },
    ),
    ace.define(
          ...
          l = (function () {
            ...
            return (
              ...
              (e.prototype.insertInLine = function (e, t) {
                ...
                return (
                  this.applyDelta(
                    { start: n, end: i, action: "insert", lines: [t] },
                    !0,
                  ),
                  this.clonePos(i)
                );
              ...
              (e.prototype.clippedPos = function (e, t) {
                ...
                return (
                  null == t && (t = i.length),
                  { row: e, column: (t = Math.min(Math.max(t, 0), i.length)) }
                );
              }),
              ...
              (e.prototype.insertMergedLines = function (e, t) {
                var n = this.clippedPos(e.row, e.column),
                  i = {
                    ...
                    column:
                      (1 == t.length ? n.column : 0) + t[t.length - 1].length,
                  };
                return (
                  this.applyDelta({
                    start: n,
                  ...
                  this.applyDelta(
                    {
                      ...
                      action: "remove",
                      lines: this.getLinesForRange({ start: i, end: o }),
                    },
                    !0,
                  ),
                  this.clonePos(i)
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        i.implement(r.prototype, o), (t.BackgroundTokenizer = r);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
          ...
          r = (function () {
            ...
            return (
              ...
              (e.prototype.update = function (e, t, n, r) {
                if (this.regExp)
                  for (
                    var s = r.firstRow, a = r.lastRow, l = {}, c = s;
                    c <= a;
                    c++
                  ) {
                    var h = this.cache[c];
                    null == h &&
                      ((h = i.getMatchOffsets(n.getLine(c), this.regExp))
                        .length > this.MAX_RANGES &&
                        (h = h.slice(0, this.MAX_RANGES)),
                      (h = h.map(function (e) {
                        return new o(c, e.offset, c, e.offset + e.length);
                      })),
                      (this.cache[c] = h.length ? h : ""));
                    for (var u = h.length; u--; ) {
                      var d = h[u].toScreenRange(n),
                        p = d.toString();
                      l[p] ||
                        ((l[p] = !0),
                        t.drawSingleLineMarker(e, d, this.clazz, r));
                    }
                  }
              }),
              e
        ...
        (r.prototype.MAX_RANGES = 500), (t.SearchHighlight = r);
      },
    ),
    ace.define(
      "ace/undomanager",
      ...
      function (e, t, n) {
        var i = (function () {
          ...
          return (
            ...
            (e.prototype.add = function (e, t, n) {
              if (!this.$fromUndo && e != this.$lastDelta) {
                if (
                  ...
                  i > this.$undoDepth - 1 &&
                    this.$undoStack.splice(0, i - this.$undoDepth + 1),
            ...
            (e.prototype.getDeltas = function (e, t) {
              null == t && (t = this.$rev + 1);
              for (
                var n = this.$undoStack, i = null, o = 0, r = n.length;
                r--;
              ...
              if (
                ...
                !(function (e, t) {
                  for (var n = 0; n < t.length; n++)
                    for (var i = t[n], o = 0; o < i.length; o++) f(e, i[o]);
                })(this.$redoStack, n),
                  (this.$redoStackBaseRev = this.$rev),
        ...
        (i.prototype.hasUndo = i.prototype.canUndo),
          (i.prototype.hasRedo = i.prototype.canRedo),
          (i.prototype.isClean = i.prototype.isAtBookmark),
          (i.prototype.markClean = i.prototype.bookmark);
        var o = e("./range").Range,
          r = o.comparePoints;
        function s(e) {
          return { row: e.row, column: e.column };
        ...
        function u(e, t) {
          ...
          if (n && i) r(e.start, t.start) < 0 ? d(t, e, 1) : d(e, t, 1);
            ...
            r(e.start, t.end) >= 0
              ? d(e, t, -1)
              : (r(e.start, t.start) <= 0 ||
                  d(e, o.fromPoints(t.start, e.start), -1),
                d(t, e, 1));
          else if (!n && i)
            r(t.start, e.end) >= 0
              ? d(t, e, -1)
              : (r(t.start, e.start) <= 0 ||
                  d(t, o.fromPoints(e.start, t.start), -1),
                d(e, t, 1));
          else if (!n && !i)
            if (r(t.start, e.end) >= 0) d(t, e, -1);
            else {
              ...
              if (!(r(t.end, e.start) <= 0))
                return (
                  r(e.start, t.start) < 0 && ((s = e), (e = g(e, t.start))),
        ...
        function g(e, t) {
          ...
          return (
            n.push(r[0].substring(0, a)),
            (r[0] = r[0].substr(a)),
            { start: s(t), end: i, lines: r, action: e.action }
          );
        }
        function f(e, t) {
          t = (function (e) {
        ...
        o.comparePoints, (t.UndoManager = i);
      },
    ),
    ace.define(
            ...
            return (
              ...
              (e.prototype.walk = function (e, t, n) {
                ...
                for (var l = 0; l < s.length; l++) {
                  if (-1 == (o = (i = s[l]).range.compareStart(t, n)))
                    return void e(null, t, n, r, a);
                  if (
                    (!e(null, i.start.row, i.start.column, r, a) &&
                      e(i.placeholder, i.start.row, i.start.column, r)) ||
                    0 === o
                  )
                    return;
              ...
              (e.prototype.getNextFoldTo = function (e, t) {
                for (var n, i, o = 0; o < this.folds.length; o++) {
                  if (-1 == (i = (n = this.folds[o]).range.compareEnd(e, t)))
    ...
    ace.define(
      ...
      function (e, t, n) {
          ...
          o = (function () {
            ...
            return (
              ...
              (e.prototype.add = function (e) {
                ...
                return (
                  i < 0 ? (i = -i - 1) : i++, this.ranges.splice(n, i - n, e)
                );
              }),
              ...
              (e.prototype.merge = function () {
                for (
                  ...
                  s < 0 ||
                    ((0 != s || e.isEmpty() || o.isEmpty()) &&
                      (i(e.end, o.end) < 0 &&
                        ((e.end.row = o.end.row),
                        (e.end.column = o.end.column)),
                      n.splice(r, 1),
                      t.push(o),
                      (o = e),
                      r--));
              ...
              (e.prototype.$onChange = function (e) {
                ...
                if ("insert" == e.action)
                  for (var l = o - i, c = -t.column + n.column; s < a; s++) {
                    ...
                    if (
                      ...
                      h.end.column == t.column &&
                        ...
                        h.end.column == r[s + 1].start.column &&
                        (h.end.column -= c),
                        (h.end.column += c),
                        (h.end.row += l);
                    }
                  ...
                  for (l = i - o, c = t.column - n.column; s < a; s++) {
                    if ((h = r[s]).start.row > o) break;
                    h.end.row < o &&
                    (i < h.end.row ||
                      (i == h.end.row && t.column < h.end.column))
                      ? ((h.end.row = i), (h.end.column = t.column))
                      : h.end.row == o
                        ? h.end.column <= n.column
                          ? (l || h.end.column > t.column) &&
                            ((h.end.column = t.column), (h.end.row = t.row))
                          : ((h.end.column += c), (h.end.row += l))
                        : h.end.row > o && (h.end.row += l),
                      h.start.row < o &&
                      (i < h.start.row ||
                        (i == h.start.row && t.column < h.start.column))
        ...
        (o.prototype.comparePoints = i), (t.RangeList = o);
      },
    ),
    ace.define(
          ...
          r = (function (e) {
            function t(t, n) {
              ...
              return (
                ...
                (i.start = t.start),
                (i.end = t.end),
                (i.sameRow = t.start.row == t.end.row),
                (i.subFolds = i.ranges = []),
                i
              );
            }
            return (
              ...
              (t.prototype.clone = function () {
                var e = new t(this.range.clone(), this.placeholder);
                return (
                  this.subFolds.forEach(function (t) {
              ...
              (t.prototype.addSubFold = function (e) {
                if (!this.range.isEqual(e)) {
                  ...
                  for (
                    var i = e.start.row, o = e.start.column, r = 0, a = -1;
                    r < this.subFolds.length &&
                    1 == (a = this.subFolds[r].range.compare(i, o));
                    r++
                  );
                  ...
                  (i = e.range.end.row), (o = e.range.end.column);
                  var h = r;
                  for (
                    a = -1;
                    h < this.subFolds.length &&
                    1 == (a = this.subFolds[h].range.compare(i, o));
                    h++
                  );
                  0 == a && h++;
                  for (
                    var u = this.subFolds.splice(r, h - r, e),
    ...
    ace.define(
      ...
      function (e, t, n) {
        var i = e("../range").Range,
          ...
          a = e("../mouse/mouse_event").MouseEvent;
        t.Folding = function () {
          (this.getFoldAt = function (e, t, n) {
            ...
            (this.getFoldStringAt = function (e, t, n, i) {
              ...
              return (
                o || (o = this.getLine(r.start.row).substring(s.end.column)),
                -1 == n
            ...
            (this.getFoldedRowCount = function (e, t) {
              for (
                var n = this.$foldData, i = t - e + 1, o = 0;
                o < n.length;
                o++
              ) {
                var r = n[o],
            ...
            (this.addFold = function (e, t) {
              ...
              e instanceof r
                ? (n = e)
                : ((n = new r(t, e)).collapseChildren = t.collapseChildren),
              ...
              for (var g = 0; g < i.length; g++) {
                ...
                if (c <= f.start.row) break;
              }
              return (
                s || (f = this.$addFoldLine(new o(this.$foldData, n))),
                this.$useWrapMode
                  ? this.$updateWrapData(f.start.row, f.start.row)
                  : this.$updateRowLengthCache(f.start.row, f.start.row),
                (this.$modified = !0),
            ...
            (this.unfold = function (e, t) {
              var n, o;
              if (null == e)
                (n = new i(0, 0, this.getLength(), 0)), null == t && (t = !0);
              else if ("number" == typeof e)
                n = new i(e, 0, e, this.getLine(e).length);
              ...
              for (
                var r = (o = this.getFoldsInRangeList(n));
                1 == o.length &&
                i.comparePoints(o[0].start, n.start) < 0 &&
                i.comparePoints(o[0].end, n.end) > 0;

              )
                this.expandFolds(o), (o = this.getFoldsInRangeList(n));
              if (
                (0 != t ? this.removeFolds(o) : this.expandFolds(o), r.length)
              )
                return r;
            }),
            ...
            (this.getDisplayLine = function (e, t, n, i) {
              ...
              return r
                ? this.getFoldDisplayLine(r, e, t, n, i)
            ...
            (this.toggleFold = function (e) {
              ...
              if (
                (t || (t = this.getFoldAt(i.start.row, i.start.column)),
            ...
            (this.getCommentFoldRange = function (e, t, n) {
              ...
              if (r && /^comment|string/.test(a)) {
                ...
                if (1 != n) {
                  do {
                    r = o.stepBackward();
                  } while (r && l.test(r.type) && !/^comment.end/.test(r.type));
                  r = o.stepForward();
                }
                if (
                  ((c.start.row = o.getCurrentTokenRow()),
                  (c.start.column =
                    o.getCurrentTokenColumn() +
                    (/^comment.start/.test(r.type) ? r.value.length : 2)),
                  (o = new s(this, e, t)),
                  -1 != n)
                ) {
                  var h = -1;
                ...
                return (
                  (c.end.row = o.getCurrentTokenRow()),
                  (c.end.column = o.getCurrentTokenColumn()),
                  /^comment.end/.test(r.type) ||
                    (c.end.column += r.value.length - 2),
                  c
                );
              }
            }),
            (this.foldAll = function (e, t, n, i) {
              ...
              if (o) {
                ...
                for (var r = (e = e || 0); r < t; r++)
                  if (
                    (null == o[r] && (o[r] = this.getFoldWidget(r)),
                    "start" == o[r] && (!i || i(r)))
                  ) {
            ...
            (this.getParentFoldRangeData = function (e, t) {
              ...
              for (var i, o = e - 1; o >= 0; ) {
                var r = n[o];
                if (
                  (null == r && (r = n[o] = this.getFoldWidget(o)),
                  "start" == r)
                ) {
                ...
                if (t.siblings) {
                  ...
                  t.children
                    ? ((c = s ? s.end.row : this.getLength()),
                      this.foldAll(e + 1, c, t.all ? 1e4 : 0))
                    : s &&
      ...
      function (e, t, n) {
        ...
        t.BracketMatch = function () {
          (this.findMatchingBracket = function (e, t) {
            ...
            return i
              ? i[1]
                ? this.$findClosingBracket(i[1], e)
                : this.$findOpeningBracket(i[2], e)
              : null;
          }),
            (this.getBracketRange = function (e) {
              ...
              if (s[1]) {
                ...
                (t = o.fromPoints(e, a)),
                  i || (t.end.column++, t.start.column--),
                  (t.cursor = t.end);
              } else {
                var a;
                if (!(a = this.$findOpeningBracket(s[2], e))) return null;
                (t = o.fromPoints(a, e)),
                  i || (t.start.column++, t.end.column--),
                  (t.cursor = t.start);
              }
              return t;
            }),
            (this.getMatchingBracketRanges = function (e, t) {
              var n = this.getLine(e.row),
                i = /([\(\[\{])|([\)\]\}])/,
                r = !t && n.charAt(e.column - 1),
                s = r && r.match(i);
              if (
                (s ||
                  ((r = (void 0 === t || t) && n.charAt(e.column)),
                  (e = { row: e.row, column: e.column + 1 }),
                  (s = r && r.match(i))),
                !s)
              )
                return null;
              var a = new o(e.row, e.column - 1, e.row, e.column),
                l = s[1]
                  ? this.$findClosingBracket(s[1], e)
                  : this.$findOpeningBracket(s[2], e);
              return l ? [a, new o(l.row, l.column, l.row, l.column + 1)] : [a];
            }),
            (this.$brackets = {
              ")": "(",
              "(": ")",
            ...
            (this.$findOpeningBracket = function (e, t, n) {
              ...
              if ((a || (a = s.stepForward()), a)) {
                ...
                for (
                  var l = t.column - s.getCurrentTokenColumn() - 2, c = a.value;
                  ;
            ...
            (this.getMatchingTags = function (e) {
              var t = new i(this, e.row, e.column),
                n = this.$findTagName(t);
              if (n)
                return "<" === t.stepBackward().value
              ...
              if ((t = e.stepForward()) && ">" === t.value) {
                ...
                do {
                  if (
                    ((t = n),
                    (s = e.getCurrentTokenRow()),
                    (l = (a = e.getCurrentTokenColumn()) + t.value.length),
                    (n = e.stepBackward()),
                    t)
                  )
                    if (-1 !== t.type.indexOf("tag-name")) {
                      ...
                      for (var v = 0; v < f; v++) e.stepForward();
                    }
                } while (n && r <= 0);
                return p && g && c && u && d && h
                  ? {
    ...
    ace.define(
      ...
      function (e, t, n) {
          ...
          f = (function () {
            function e(t, n) {
              ...
              this.bgTokenizer.on("update", function (e) {
                ...
                (this.$onChange = this.onChange.bind(this)),
                ("object" == typeof t && t.getLine) || (t = new u(t)),
                this.setDocument(t),
            ...
            return (
              ...
              (e.fromJSON = function (t) {
                ...
                return (
                  ...
                  i.setAnnotations(t.annotations),
                  i.setBreakpoints(t.breakpoints),
                  i.setMode(t.mode),
                  i.setScrollLeft(t.scrollLeft),
                  i.setScrollTop(t.scrollTop),
                  i.setUndoManager(n),
                  i.selection.fromJSON(t.selection),
                  i
                );
              }),
              (e.prototype.toJSON = function () {
              ...
              (e.prototype.getTokenAt = function (e, t) {
                var n,
                  i = this.bgTokenizer.getTokens(e),
                  o = 0;
                if (null == t) {
                  var r = i.length - 1;
                  ...
                  for (
                    r = 0;
                    r < i.length && !((o += i[r].value.length) >= t);
                    r++
                  );
                return (n = i[r])
                  ? ((n.index = r), (n.start = o - n.value.length), n)
                  : null;
              }),
              ...
              (e.prototype.addMarker = function (e, t, n, i) {
                var o = this.$markerId++,
                  r = {
                    range: e,
                    type: n || "line",
              ...
              (e.prototype.removeMarker = function (e) {
                ...
                t &&
                  (delete (t.inFront ? this.$frontMarkers : this.$backMarkers)[
                    e
                  ],
                  this._signal(
              ...
              (e.prototype.highlightLines = function (e, t, n, i) {
                "number" != typeof t && ((n = t), (t = e)),
                  n || (n = "ace_step");
              ...
              (e.prototype.getWordRange = function (e, t) {
                var n = this.getLine(e),
                  i = !1;
                if (
                  (t > 0 && (i = !!n.charAt(t - 1).match(this.tokenRe)),
              ...
              (e.prototype.setMode = function (e, t) {
                ...
                if (
                  (this.$modes["ace/mode/text"] ||
                    (this.$modes["ace/mode/text"] = new c()),
                  this.$modes[i] && !n)
                )
              ...
              (e.prototype.$onChangeMode = function (e, t) {
                if ((t || (this.$modeId = e.$id), this.$mode !== e)) {
                  ...
                  if (void 0 !== i.on) {
                    var o = this.onReloadTokenizer.bind(this);
                    i.on("update", o);
                  }
              ...
              (e.prototype.$computeWidth = function (e) {
                if (this.$modified || e) {
                  ...
                  for (
                    ...
                    null == n[l] &&
                      (n[l] = this.$getStringScreenWidth(t[l])[0]),
                      n[l] > i && (i = n[l]);
                  }
                  this.screenWidth = i;
                }
                  ...
                  s.start &&
                    (i
                      ? n(s)
                        ...
                        : ((o = s.start),
                          -1 == i.compare(o.row, o.column) &&
                            (i = h.fromPoints(s.start, s.start)))
                      : (i = n(s)
                          ? h.fromPoints(s.start, s.end)
                          : h.fromPoints(s.start, s.start)));
                }
                return i;
              }),
              (e.prototype.replace = function (e, t) {
              ...
              (e.prototype.moveText = function (e, t, n) {
                ...
                if (!n) {
                  ...
                  (c = s ? -e.end.column : e.start.column - e.end.column) &&
                    ...
                    o.map(function (e) {
                      return (
                        (e = e.clone()).start.row == a.row &&
                          (e.start.column += c),
                        e.end.row == a.row && (e.end.column += c),
                        (e.start.row += s),
                        (e.end.row += s),
                        e
                      );
              ...
              (e.prototype.outdentRows = function (e) {
                for (
                  ...
                  s < i && "\t" == r.charAt(s)
                    ...
                    : ((n.start.column = 0), (n.end.column = s)),
                    this.remove(n);
                }
              }),
              (e.prototype.$moveLines = function (e, t, n) {
                ...
                var r = new h(e, 0, t, Number.MAX_VALUE),
                  s = this.getFoldsInRange(r).map(function (e) {
                    return (
                      ((e = e.clone()).start.row += i), (e.end.row += i), e
                    );
                  }),
                  a =
                    0 == n
                ...
                return (
                  this.doc.insertFullLines(e + i, a),
              ...
              (e.prototype.$updateInternalDataOnChange = function (e) {
                ...
                if (((this.$updating = !0), 0 != a))
                  if ("remove" === n) {
                    ...
                    var h = 0;
                    if ((f = this.getFoldLine(o.row))) {
                      f.addRemoveChars(o.row, o.column, i.column - o.column),
                        f.shiftRow(-a);
                    ...
                    for (; h < c.length; h++) {
                      (f = c[h]).start.row >= o.row && f.shiftRow(-a);
                    }
                    s = r;
                  } else {
                    var d = Array(a);
                    ...
                    p.splice.apply(p, d);
                    (c = this.$foldData), (h = 0);
                    if ((f = this.getFoldLine(r))) {
                      var g = f.range.compareInside(i.row, i.column);
                      0 == g
                        ? (f = f.split(i.row, i.column)) &&
                          (f.shiftRow(a),
                          f.addRemoveChars(s, 0, o.column - i.column))
                        : -1 == g &&
                          (f.addRemoveChars(r, 0, o.column - i.column),
                          f.shiftRow(a)),
                        (h = c.indexOf(f) + 1);
                    }
                    for (; h < c.length; h++) {
                      var f;
                      (f = c[h]).start.row >= r && f.shiftRow(a);
                    }
                  }
                else
                  (a = Math.abs(e.start.column - e.end.column)),
                    "remove" === n &&
                      ...
                      this.removeFolds(l),
                      (a = -a)),
                    (f = this.getFoldLine(r)) &&
                      f.addRemoveChars(r, i.column, a);
                return (
                  t &&
                  ...
                  (this.$updating = !1),
                  t
                    ? this.$updateWrapData(r, s)
                    : this.$updateRowLengthCache(r, s),
                  l
                );
              }),
              ...
              (e.prototype.$updateWrapData = function (e, t) {
                var n,
                  ...
                  a = this.$wrapLimit,
                  l = e;
                for (t = Math.min(t, o.length - 1); l <= t; )
                  (i = this.getFoldLine(l, i))
                    ? ((n = []),
                      i.walk(
                        function (e, t, i, r) {
                          var s;
                          if (null != e) {
                            (s = this.$getDisplayTokens(e, n.length))[0] = y;
                            for (var a = 1; a < s.length; a++) s[a] = w;
                          } else
                        ...
                        i.end.row,
                        o[i.end.row].length + 1,
                      ),
                      (s[i.start.row] = this.$computeWrapSplits(n, a, r)),
                      (l = i.end.row + 1))
                    : ((n = this.$getDisplayTokens(o[l])),
                      (s[l] = this.$computeWrapSplits(n, a, r)),
                      l++);
              }),
              (e.prototype.$computeWrapSplits = function (e, t, n) {
                ...
                var i = [],
                  ...
                  s = 0,
                  a = this.$wrapAsCode,
                  l = this.$indentedSoftWrap,
                  c =
                    t <= Math.max(2 * n, 8) || !1 === l ? 0 : Math.floor(t / 2);
                function h(t) {
                  for (var o = t - r, h = r; h < t; h++) {
                    var d = e[h];
                    (12 !== d && 2 !== d) || (o -= 1);
                  }
                  i.length ||
              ...
              (e.prototype.screenToDocumentPosition = function (e, t, n) {
                ...
                var i,
                  ...
                  u = c.length;
                if (u && h >= 0) {
                  (a = c[h]), (r = this.$docRowCache[h]);
                  var d = e > c[u - 1];
                } else d = !u;
                for (
                  var p = this.getLength() - 1,
                    g = this.getNextFoldLine(r),
                    f = g ? g.start.row : 1 / 0;
                  a <= e && !(a + (l = this.getRowLength(r)) > e || r >= p);

                )
                  (a += l),
                    ++r > f &&
                      ((r = g.end.row + 1),
                      (f = (g = this.getNextFoldLine(r, g))
                        ? g.start.row
                        : 1 / 0)),
                    d &&
                      (this.$docRowCache.push(r), this.$screenRowCache.push(a));
                if (g && g.start.row <= r)
                  (i = this.getFoldDisplayLine(g)), (r = g.start.row);
                else {
                  if (a + l <= e || r > p)
                    return { row: p, column: this.getLine(p).length };
                  (i = this.getLine(r)), (g = null);
                }
                var m = 0,
                  v = Math.floor(e - a);
                if (this.$useWrapMode) {
                  var y = this.$wrapData[r];
                  y &&
                    ((o = y[v]),
                    v > 0 &&
                      y.length &&
                      ((m = y.indent),
                      (s = y[v - 1] || y[y.length - 1]),
                      (i = i.substring(s))));
                }
                return (
                  void 0 !== n &&
                  ...
                  g ? g.idxToPosition(s) : { row: r, column: s }
                );
              }),
              (e.prototype.documentToScreenPosition = function (e, t) {
                ...
                var i,
                  o = 0,
                  r = null;
                (i = this.getFoldAt(e, t, 1)) &&
                  ((e = i.start.row), (t = i.start.column));
                var s,
                  a = 0,
                  l = this.$docRowCache,
                  ...
                  h = l.length;
                if (h && c >= 0) {
                  (a = l[c]), (o = this.$screenRowCache[c]);
                  var u = e > l[h - 1];
                } else u = !h;
                for (
                  var d = this.getNextFoldLine(a), p = d ? d.start.row : 1 / 0;
                  a < e;
                  ...
                  (o += this.getRowLength(a)),
                    (a = s),
                    u &&
                      (this.$docRowCache.push(a), this.$screenRowCache.push(o));
                }
                var g = "";
                d && a >= p
                ...
                return (
                  this.lineWidgets &&
                    ...
                    (o += this.lineWidgets[a].rowsAbove),
                  { row: o, column: f + this.$getStringScreenWidth(g)[0] }
                );
              }),
                ...
                if (this.$useWrapMode)
                  for (
                    ...
                    (e += r ? r.length + 1 : 1),
                      ++i > o &&
                        ((i = t.end.row + 1),
                        (o = (t = this.$foldData[a++]) ? t.start.row : 1 / 0));
                  }
                else {
                  e = this.getLength();
                  for (var s = this.$foldData, a = 0; a < s.length; a++)
                    e -= (t = s[a]).end.row - t.start.row;
                }
                return (
        ...
        (f.$uid = 0),
          (f.prototype.$modes = s.$modes),
          (f.prototype.getValue = f.prototype.toString),
          (f.prototype.$defaultUndoManager = {
            undo: function () {},
            redo: function () {},
            hasUndo: function () {},
            hasRedo: function () {},
          ...
          (f.prototype.$overwrite = !1),
          (f.prototype.$mode = null),
          (f.prototype.$modeId = null),
          (f.prototype.$scrollTop = 0),
          (f.prototype.$scrollLeft = 0),
          (f.prototype.$wrapLimit = 80),
          (f.prototype.$useWrapMode = !1),
          (f.prototype.$wrapLimitRange = { min: null, max: null }),
          (f.prototype.lineWidgets = null),
          (f.prototype.isFullWidth = S),
          i.implement(f.prototype, a);
        var m = 1,
          v = 2,
          y = 3,
          w = 4,
          ...
          s = (function () {
            ...
            return (
              ...
              (e.prototype.findAll = function (e) {
                ...
                if (t.$isMultiLine) {
                  ...
                  e: for (var u = a.offset || 0; u <= h; u++) {
                    ...
                    (l && l.end.row === u && l.end.column > f) ||
                      (s.push((l = new r(u, f, u + c - 1, m))),
                      c > 2 && (u = u + c - 2));
                  }
                } else
                  for (var v = 0; v < o.length; v++) {
                    var y = i.getMatchOffsets(o[v], a);
                ...
                if (n) {
                  ...
                  for (
                    v = 0, d = s.length - 1;
                    v < d && s[v].start.column < b && 0 == s[v].start.row;

                  )
                    v++;
                  for (
                    var x = n.end.row - n.start.row;
                    v < d && s[d].end.column > $ && s[d].end.row == x;

                  )
                    d--;
                  for (s = s.slice(v, d + 1), v = 0, d = s.length; v < d; v++)
                    (s[v].start.row += n.start.row),
                      (s[v].end.row += n.start.row);
                }
                return s;
              }),
              (e.prototype.replace = function (e, t) {
              ...
              (e.prototype.$assembleRegExp = function (e, t) {
                ...
                try {
                  new RegExp(n, "u"), (e.$supportsUnicodeFlag = !0), (o += "u");
                } catch (t) {
              ...
              (e.prototype.$matchIterator = function (e, t) {
                ...
                var o = 1 == t.backwards,
                  ...
                  a = t.range,
                  l = t.start;
                l || (l = a ? a[o ? "end" : "start"] : e.selection.getRange()),
                  l.start && (l = l[r != o ? "end" : "start"]);
                var c = a ? a.start.row : 0,
                  h = a ? a.end.row : e.getLength() - 1;
                if (o)
                  var u = function (e) {
                    var n = l.row;
                    if (!p(n, l.column, e)) {
                  ...
                  u = function (e) {
                    var n = l.row;
                    if (!p(n, l.column, e)) {
                      for (n += 1; n <= h; n++) if (p(n, 0, e)) return;
                      if (0 != t.wrap)
                        for (n = c, h = l.row; n <= h; n++)
                          if (p(n, 0, e)) return;
                    }
                  };
                if (t.$isMultiLine)
                  var d = n.length,
                    p = function (t, i, r) {
                      var s = o ? t - d + 1 : t;
                      if (!(s < 0 || s + d > e.getLength())) {
                        var a = e.getLine(s),
                          l = a.search(n[0]);
                        if (!((!o && l < i) || -1 === l)) {
                          for (var c = 1; c < d; c++)
                            if (-1 == (a = e.getLine(s + c)).search(n[c]))
                              return;
                          var h = a.match(n[d - 1])[0].length;
                          if (!(o && h > i))
                            return !!r(s, l, s + d - 1, h) || void 0;
                        }
                      }
                    };
                else if (o)
                  p = function (t, o, r) {
                    var a,
                      ...
                      c = [],
                      h = 0;
                    for (n.lastIndex = 0; (a = n.exec(l)); ) {
                      var u = a[0].length;
                      if (((h = a.index), !u)) {
                        if (h >= l.length) break;
                        n.lastIndex = h += i.skipEmptyMatch(l, h, s);
                      }
                      if (a.index + u > o) break;
                      c.push(a.index, u);
                    }
                    for (var d = c.length - 1; d >= 0; d -= 2) {
                      var p = c[d - 1];
                      if (r(t, p, t, p + (u = c[d]))) return !0;
                    }
                  };
                else
                  p = function (t, o, r) {
                    var a,
                      l,
                      c = e.getLine(t);
                    for (n.lastIndex = o; (l = n.exec(c)); ) {
                      var h = l[0].length;
                      if (r(t, (a = l.index), t, a + h)) return !0;
                      if (
                        !h &&
                        ((n.lastIndex = a += i.skipEmptyMatch(c, a, s)),
                        a >= c.length)
                      )
                        return !1;
                    }
            ...
            return (
              ...
              (e.prototype.bindKey = function (e, t, n) {
                if (
                  ("object" == typeof e &&
                    e &&
                    (null == n && (n = e.position), (e = e[this.platform])),
                  e)
                )
              ...
              (e.prototype._addCommandToBinding = function (e, t, n) {
                ...
                if (t)
                  if (!o[e] || this.$singleCommand) o[e] = t;
                  else {
                    Array.isArray(o[e])
                      ? -1 != (i = o[e].indexOf(t)) && o[e].splice(i, 1)
                      : (o[e] = [o[e]]),
                      "number" != typeof n && (n = c(t));
                    var r = o[e];
              ...
              (e.prototype.parseKeys = function (e) {
                ...
                for (var o = 0, s = t.length; s--; ) {
                  ...
                  if (null == a)
                    return (
                      "undefined" != typeof console &&
                        console.error("invalid modifier " + t[s] + " in " + e),
                      !1
                    );
                  o |= a;
                }
              ...
              (e.prototype.handleKeyboard = function (e, t, n, i) {
                if (!(i < 0)) {
                  var o = a[t] + n,
    ...
    ace.define(
      ...
      function (e, t, n) {
        var i,
          ...
          l = (function (e) {
            function t(t, n) {
              ...
              return (
                (i.byName = i.commands),
                i.setDefaultHandler("exec", function (e) {
                  return e.args
        ...
        r.implement(l.prototype, a), (t.CommandManager = l);
      },
    ),
    ace.define(
              ...
              for (
                var t = e.selection.isBackwards(),
                  ...
                  o = t
                    ? e.selection.getSelectionAnchor()
                    : e.selection.getSelectionLead(),
                  s = e.session.doc.getLine(n.row).length,
                  a = e.session.doc
                    .getTextRange(e.selection.getRange())
                    .replace(/\n\s*/, " ").length,
                  l = e.session.doc.getLine(n.row),
                  c = n.row + 1;
                c <= o.row + 1;
                c++
              ) {
                var h = i.stringTrimLeft(
                  i.stringTrimRight(e.session.doc.getLine(c)),
                );
                0 !== h.length && (h = " " + h), (l += h);
              }
              o.row + 1 < e.session.doc.getLength() - 1 &&
                (l += e.session.doc.getNewLineCharacter()),
                e.clearSelection(),
                e.session.doc.replace(new r(n.row, 0, o.row + 2, 0), l),
                a > 0
                  ? (e.selection.moveCursorTo(n.row, n.column),
                    e.selection.selectTo(n.row, n.column + a))
                  : ((s = e.session.doc.getLine(n.row).length > s ? s + 1 : s),
                    e.selection.moveCursorTo(n.row, s));
            },
            multiSelectAction: "forEach",
            readOnly: !0,
          },
          {
            ...
            exec: function (e) {
              ...
              for (var s = 0; s < i.length; s++)
                s == i.length - 1 &&
                  ((i[s].end.row === t && i[s].end.column === n) ||
                    o.push(new r(i[s].end.row, i[s].end.column, t, n))),
                  0 === s
                    ? (0 === i[s].start.row && 0 === i[s].start.column) ||
                      o.push(new r(0, 0, i[s].start.row, i[s].start.column))
                    : o.push(
                        new r(
                          i[s - 1].end.row,
                          i[s - 1].end.column,
              ...
              for (s = 0; s < o.length; s++) e.selection.addRange(o[s], !1);
            },
            readOnly: !0,
            scrollIntoView: "none",
          },
          ...
          o = (function () {
            ...
            return (
                  ...
                  n[r] &&
                    (s
                      ? n[o]
                        ? (n[r].hidden = s)
                        : (n[o] = n[r])
                      : (n[o] == n[r] && (n[o] = void 0), (n[r].hidden = s)));
                }
              }),
              (e.prototype.updateOnChange = function (e) {
                ...
                if (t) {
                  ...
                  if (0 === i);
                    ...
                    var o = t.splice(n + 1, i);
                    !t[n] && o[o.length - 1] && (t[n] = o.pop()),
                      o.forEach(function (e) {
              ...
              (e.prototype.addLineWidget = function (e) {
                ...
                e.html &&
                  ...
                  e.el &&
                    ...
                    e.className && i.addCssClass(e.el, e.className),
              ...
              (e.prototype.getWidgetsAtRow = function (e) {
                for (
                  var t = this.session.lineWidgets, n = t && t[e], i = [];
                  n;
                ...
                if (n && n.length) {
                  for (var o = 1 / 0, r = 0; r < n.length; r++) {
                    ...
                    if (s && s.el && s.session == this.session) {
                      ...
                      s.coverLine &&
                        (a -= this.session.getRowLineCount(s.row)) < 0 &&
                        (a = 0),
                        s.rowCount != a &&
                  ...
                  for (var s = o; s <= r; s++) {
                    ...
                    if (a && a.el)
                      if (a.hidden)
                        ...
                        a.coverLine ||
                          (l +=
                            n.lineHeight * this.session.getRowLineCount(a.row)),
          ...
          r = (function () {
            function e(e) {
              (this.editor = e),
                ...
                (this.annotationTooltip = new o(this.editor));
            }
            return (
                        ...
                        if (null !== t || null !== n)
                          return null === t && null !== n
                            ...
                            : null !== t && null === n
                              ...
                              : Math.abs(n - e) < Math.abs(t - e)
                                ? ((this.activeRowIndex = n),
                                  (this.activeLane = "annotation"),
                                  void this.$focusAnnotation(
                                    this.activeRowIndex,
                                  ))
                                : ((this.activeRowIndex = t),
                                  (this.activeLane = "fold"),
                                  void this.$focusFoldWidget(
                                    this.activeRowIndex,
                                  ));
                      }.bind(this),
                      10,
                  ...
                  if (e.keyCode !== i.up)
                    if (e.keyCode !== i.down) {
                      if (e.keyCode === i.left)
                        return (
                          e.preventDefault(),
                          void this.$switchLane("annotation")
                        );
                      if (e.keyCode === i.right)
                        return (
                          e.preventDefault(), void this.$switchLane("fold")
                        );
                      if (e.keyCode !== i.enter && e.keyCode !== i.space);
                      else
                        switch ((e.preventDefault(), this.activeLane)) {
                                ...
                                setTimeout(
                                  function () {
                                    this.$rowIndexToRow(this.activeRowIndex) !==
                                      ...
                                      (this.activeRowIndex =
                                        this.$rowToRowIndex(t)),
                                      this.$focusFoldWidget(
                                        this.activeRowIndex,
                                      ));
                                  }.bind(this),
                                  10,
                          ...
                          case "annotation":
                            var n =
                                this.lines.cells[
                                  this.activeRowIndex
                                ].element.childNodes[2].getBoundingClientRect(),
                              o = this.annotationTooltip.getElement().style;
                            (o.left = n.right + "px"),
                              (o.top = n.bottom + "px"),
              ...
              (e.prototype.$isFoldWidgetVisible = function (e) {
                var t = this.editor.isRowFullyVisible(this.$rowIndexToRow(e)),
                  n = "none" !== this.$getFoldWidget(e).style.display;
                return t && n;
              }),
              (e.prototype.$isAnnotationVisible = function (e) {
                var t = this.editor.isRowFullyVisible(this.$rowIndexToRow(e)),
                  n = "none" !== this.$getAnnotation(e).style.display;
                return t && n;
              }),
              ...
              (e.prototype.$findNearestFoldWidget = function (e) {
                ...
                for (
                  var t = 0;
                  e - t > 0 || e + t < this.lines.getLength() - 1;
              ...
              (e.prototype.$moveFoldWidgetUp = function () {
                for (var e = this.activeRowIndex; e > 0; )
                  if ((e--, this.$isFoldWidgetVisible(e)))
                    return (
                      this.$blurFoldWidget(this.activeRowIndex),
              ...
              (e.prototype.$rowToRowIndex = function (e) {
                for (var t = 0; t < this.lines.getLength(); t++) {
                  if (this.lines.get(t).row == e) return t;
                }
                return null;
              }),
              e
        ...
        var s = (function () {
          ...
          return (
            (e.prototype.getKey = function () {
              return i.keyCodeToString(this.domEvent.keyCode);
            }),
    ...
    ace.define(
      ...
      function (e, t, n) {
          ...
          k = (function () {
            function e(t, n, i) {
              ...
              (this.container = o),
                ...
                (this.commands = new m(a.isMac ? "mac" : "win", v)),
                "object" == typeof document &&
                  ((this.textInput = new l(t.getTextAreaContainer(), this)),
                ...
                this.setSession(n || (i && i.session) || new d("")),
                y.resetOptions(this),
                i && this.setOptions(i),
            ...
            return (
                  ...
                  if (n) {
                    switch (n) {
                      ...
                      case "selectionPart":
                        ...
                        (i.start.row >= o.lastRow || i.end.row <= o.firstRow) &&
              ...
              (e.prototype.setKeyboardHandler = function (e, t) {
                if (e && "string" == typeof e && "ace" != e) {
                  this.$keybindingId = e;
                  var n = this;
                  y.loadModule(["keybinding", e], function (i) {
                    n.$keybindingId == e &&
                  ...
                  (this.$highlightPending = !0),
                    setTimeout(function () {
                      ...
                      if (t && !t.destroyed) {
                        ...
                        var n = e.getCursorPosition(),
                          i = e.getKeyboardHandler(),
                          o =
                            i &&
                            i.$getDirectionForHighlight &&
                            i.$getDirectionForHighlight(e),
                          r = t.getMatchingBracketRanges(n, o);
                        if (!r) {
                          var s = new w(t, n.row, n.column).getCurrentToken();
                          if (s && /\b(?:tag-open|tag-name)/.test(s.type)) {
                            var a = t.getMatchingTags(n);
                            a && (r = [a.openTagName, a.closeTagName]);
                          }
                        }
                        if (
                          (!r &&
                            t.$mode.getMatching &&
                            (r = t.$mode.getMatching(e.session)),
                          r)
                        ) {
                          var l = "ace_bracket";
                          Array.isArray(r)
                            ? 1 == r.length && (l = "ace_error_bracket")
                            : (r = [r]),
                            2 == r.length &&
                              (0 == g.comparePoints(r[0].end, r[1].start)
                                ? (r = [g.fromPoints(r[0].start, r[1].end)])
                                : 0 == g.comparePoints(r[0].start, r[1].end) &&
                                  (r = [g.fromPoints(r[1].start, r[0].end)])),
                            (t.$bracketHighlight = {
                              ranges: r,
                              markerIds: r.map(function (e) {
              ...
              (e.prototype.getCopyText = function () {
                ...
                if (!e && this.$copyWithEmptySelection) {
                  n = !0;
                  for (
                    var i = this.selection.getAllRanges(), o = 0;
                    o < i.length;
                    o++
                  ) {
                    var r = i[o];
                ...
                var s = { text: e };
                return (
                  this._signal("copy", s), (C.lineMode = !!n && s.text), s.text
                );
              }),
              ...
              (e.prototype.$handlePaste = function (e) {
                ...
                if (!this.inMultiSelectMode || this.inVirtualSelectionMode)
                  n
                    ? i.insert({ row: this.selection.lead.row, column: 0 }, t)
                    : this.insert(t);
                else if (n)
                  ...
                  if (o.length != r.length || s)
                    return this.commands.exec("insertstring", this, t);
                  for (var a = r.length; a--; ) {
                    var l = r[a];
                    l.isEmpty() || i.remove(l), i.insert(l.start, o[a]);
                  }
                }
              }),
              ...
              (e.prototype.insert = function (e, t) {
                ...
                if (
                  ...
                  if (this.session.getOverwrite() && -1 == e.indexOf("\n")) {
                    ((s = g.fromPoints(o, o)).end.column += e.length),
              ...
              (e.prototype.autoIndent = function () {
                ...
                if (this.selection.isEmpty())
                  (e = 0), (t = n.doc.getLength() - 1);
                else {
                  var o = this.getSelectionRange();
                  (e = o.start.row), (t = o.end.row);
                }
                for (
                  var r,
                    s,
                  ...
                  d > 0 &&
                    ((l = n.getState(d - 1)),
                    (c = n.getLine(d - 1)),
                    (h = i.getNextLineIndent(l, c, u))),
                    (r = n.getLine(d)),
                    h !== (s = i.$getIndent(r)) &&
                      (s.length > 0 &&
                        ((a = new g(d, 0, d, s.length)), n.remove(a)),
                      h.length > 0 && n.insert({ row: d, column: 0 }, h)),
                    i.autoOutdent(l, n, d);
              }),
              ...
              (e.prototype.applyComposition = function (e, t) {
                ...
                (t.extendLeft || t.extendRight) &&
                  (((n = this.selection.getRange()).start.column -=
                    t.extendLeft),
              ...
              (e.prototype.transposeLetters = function () {
                if (this.selection.isEmpty()) {
                  ...
                  if (0 !== t) {
                    ...
                    t < o.length
                      ? ((n = o.charAt(t) + o.charAt(t - 1)),
                        (i = new g(e.row, t - 1, e.row, t + 1)))
                      : ((n = o.charAt(t - 1) + o.charAt(t - 2)),
                        (i = new g(e.row, t - 2, e.row, t))),
              ...
              (e.prototype.indent = function () {
                ...
                if (!(t.start.row < t.end.row)) {
                  ...
                  if (this.session.getUseSoftTabs())
                    ...
                    for (l = a % r; " " == i[t.start.column - 1] && l; )
                      t.start.column--, l--;
              ...
              (e.prototype.sortLines = function () {
                ...
                for (i = e.first; i <= e.last; i++) {
                  ...
                  (o.start.row = i),
                    (o.end.row = i),
                    (o.end.column = r.length),
                    t.replace(o, n[i - e.first]);
                }
              }),
              ...
              (e.prototype.modifyNumber = function (e) {
                ...
                if (!isNaN(parseFloat(o)) && isFinite(o)) {
                  ...
                  if (r) {
                    ...
                    (l *= Math.pow(10, a)),
                      s !== r.end && n < s
                        ? (e *= Math.pow(10, r.end - n - 1))
                        : (e *= Math.pow(10, r.end - n)),
                      (l += e);
                    ...
                    this.session.replace(h, c),
                      this.moveCursorTo(
                        t,
                        Math.max(r.start + 1, n + c.length - r.value.length),
                      );
                  }
                  ...
                  o.forEach(function (t, o) {
                    (l = a + t.length),
                      r >= a &&
                        ...
                        c.moveCursorTo(e, a + i),
                        c.selection.selectTo(e, l + i)),
                      (a = l);
                  });
                for (var h, u = this.$toggleWordPairs, d = 0; d < u.length; d++)
                  for (var p = u[d], g = 0; g <= 1; g++) {
                    var f = +!g,
                      m = n.match(
                        new RegExp(
                          "^\\s?_?(" + s.escapeRegExp(p[g]) + ")\\s?$",
                          "i",
                        ),
                      );
                    if (m)
                      n.match(
                        ...
                        ((h = n.replace(
                          new RegExp(s.escapeRegExp(p[g]), "i"),
                          function (e) {
                            var t = p[f];
                            return (
                              e.toUpperCase() == e
              ...
              (e.prototype.findLinkAt = function (e, t) {
                ...
                var a,
                  ...
                  c = 0;
                try {
                  for (var h = i(r), u = h.next(); !u.done; u = h.next()) {
                    var d = u.value;
                    if (
                      ((c = l + d.length),
                      s >= l && s <= c && d.match(/((?:https?|ftp):\/\/[\S]+)/))
                    ) {
                      a = d.replace(/[\s:.,'";}\]]+$/, "");
                      break;
                    }
              ...
              (e.prototype.$moveLines = function (e, t) {
                ...
                if (!o.inMultiSelectMode || this.inVirtualSelectionMode) {
                  ...
                  for (var a = 0, l = 0, c = s.length, h = 0; h < c; h++) {
                    ...
                    s[h].moveBy(a, 0);
                    for (
                      var d = (n = this.$getSelectedRows(s[h])).first,
                        p = n.last;
                      ++h < c;
                    ...
                    for (
                      h--,
                        a = this.session.$moveLines(d, p, t ? 0 : e),
                        t && -1 == e && (u = h + 1);
                      u <= h;
              ...
              (e.prototype.$moveByPage = function (e, t) {
                ...
                n.scrollBy(0, o * i.lineHeight),
                  null != t && n.scrollCursorIntoView(null, 0.5),
              ...
              (e.prototype.scrollToLine = function (e, t, n, i) {
                  ...
                  do {
                    if (s.value.match(/[{}()\[\]]/g)) {
                      ...
                      -1 !== s.type.indexOf("tag-name") &&
                        (isNaN(h[s.value]) && (h[s.value] = 0),
                        "<" === o.value && r > 1
                          ? h[s.value]++
                          : "</" === o.value && h[s.value]--,
                        -1 === h[s.value] && ((a = "tag"), (c = !0)));
                    c || ((o = s), r++, (s = i.stepForward()), (u = 0));
                  } while (s && !c);
                  if (a) {
                    var p, f;
                    if ("bracket" === a)
              ...
              (e.prototype.replaceAll = function (e, t) {
                ...
                return this.selection.setSelectionRange(o), i;
              }),
              ...
              (e.prototype.find = function (e, t, n) {
                ...
                return t.preventScroll
                  ? r
                  : r
                    ? (this.revealRange(r, n), r)
                    : (t.backwards ? (i.start = i.end) : (i.end = i.start),
                      void this.selection.setRange(i));
              }),
                      ...
                      if (
                        ...
                        null !=
                          (i =
                            ...
                            (!(
                              r.top < s.height &&
                              r.top + t.top + s.lineHeight > window.innerHeight
                            ) &&
                              null)) &&
                          ((o.style.top = a + "px"),
              ...
              (e.prototype.prompt = function (e, t, n) {
                var i = this;
                y.loadModule("ace/ext/prompt", function (o) {
                  o.prompt(i, e, t, n);
                });
              }),
              e
        ...
        (k.$uid = 0),
          (k.prototype.curOp = null),
          (k.prototype.prevOp = {}),
          (k.prototype.$mergeableCommands = [
            "backspace",
            "del",
            "insertstring",
          ]),
          (k.prototype.$toggleWordPairs = [
            ["first", "last"],
            ["true", "false"],
            ["yes", "no"],
            ["width", "height"],
          ...
          o.implement(k.prototype, f),
          y.defineOptions(k.prototype, "editor", {
            selectionStyle: {
              set: function (e) {
                this.onSelectionChange(),
              ...
              set: function (e) {
                ...
                e
                  ? ((this.renderer.enableKeyboardAccessibility = !0),
                    ...
                    this.textInput.setNumberOfExtraLines(a.isWin ? 3 : 0),
            ...
            return (
              ...
              (e.prototype.computeLineTop = function (e, t, n) {
                var i = t.firstRowScreen * t.lineHeight,
                  o = Math.floor(i / this.canvasHeight);
                return (
                  n.documentToScreenRow(e, 0) * t.lineHeight -
                  o * this.canvasHeight
                );
              }),
              ...
              (e.prototype.push = function (e) {
                if (Array.isArray(e)) {
                  ...
                  for (
                    var t = i.createFragment(this.element), n = 0;
                    n < e.length;
                    n++
                  )
              ...
              (e.prototype.createCell = function (e, t, n, o) {
                var r = this.cellCache.pop();
                if (!r) {
                  var s = i.createElement("div");
                  o && o(s),
                    this.element.appendChild(s),
                    (r = { element: s, text: "", row: e });
                }
                return (r.row = e), r;
              }),
              e
    ...
    ace.define(
      ...
      function (e, t, n) {
            ...
            return (
              ...
              (e.prototype.setAnnotations = function (e) {
                ...
                for (var t = 0; t < e.length; t++) {
                  ...
                  var s = n.text,
                    a = n.type;
                  (s = s ? r.escapeHTML(s) : n.html || ""),
                    -1 === o.text.indexOf(s) &&
                      (o.text.push(s), o.type.push(a));
                  var l = n.className;
                  l
                    ? (o.className = l)
                    : "error" == a
              ...
              (e.prototype.update = function (e) {
                ...
                for (
                  ...
                  (s = this.$lines.get(++a))
                    ? (s.row = l)
                    : ((s = this.$lines.createCell(l, e, this.session, h)),
                      this.$lines.push(s)),
              ...
              (e.prototype.$updateGutterWidth = function (e) {
                ...
                var r = n
                    ? n.getWidth(t, o, e)
                    : o.toString().length * e.characterWidth,
                  s = this.$padding || this.$computePadding();
                (r += s.left + s.right) === this.gutterWidth ||
                  isNaN(r) ||
                  ((this.gutterWidth = r),
                    ...
                    for (var n = 0; n < t.length; n++) {
                      ...
                      if (i.row >= this.$cursorRow) {
                        if (i.row > this.$cursorRow) {
                          ...
                          if (!(n > 0 && o && o.start.row == t[n - 1].row))
                            break;
                          i = t[n - 1];
                        }
                        (i.element.className =
                          "ace_gutter-active-line " + i.element.className),
                          (this.$cursorCell = i);
                        break;
                      }
                    }
              ...
              (e.prototype.scrollLines = function (e) {
                ...
                var n = Math.min(
                  ...
                  i = this.oldLastRow;
                if (((this.oldLastRow = n), !t || i < e.firstRow))
                  return this.update(e);
                if (n < t.firstRow) return this.update(e);
                if (t.firstRow < e.firstRow)
                  for (
                    var o = this.session.getFoldedRowCount(
                      t.firstRow,
                      e.firstRow - 1,
                    );
                    o > 0;
                    ...
                    this.$lines.shift();
                if (i > n)
                  for (o = this.session.getFoldedRowCount(n + 1, i); o > 0; o--)
                    this.$lines.pop();
                e.firstRow < t.firstRow &&
                  this.$lines.unshift(
                    this.$renderLines(e, e.firstRow, t.firstRow - 1),
                  ),
                  n > i && this.$lines.push(this.$renderLines(e, i + 1, n)),
              ...
              (e.prototype.$renderLines = function (e, t, n) {
                for (
                  ...
                  o > s &&
                    ((o = r.end.row + 1),
                    (s = (r = this.session.getNextFoldLine(o, r))
                      ? r.start.row
                      : 1 / 0)),
                    !(o > n);

                ) {
                  var a = this.$lines.createCell(o, e, this.session, h);
                  this.$renderCell(a, e, r, o), i.push(a), o++;
                }
                return i;
              }),
              (e.prototype.$renderCell = function (e, t, n, o) {
                var r = e.element,
                  s = this.session,
                  a = r.childNodes[0],
                  c = r.childNodes[1],
                  ...
                  p = s.$breakpoints,
                  g = s.$decorations,
                  f = s.gutterRenderer || this.$renderer,
                  m = this.$showFoldWidgets && s.foldWidgets,
                  v = n ? n.start.row : Number.MAX_VALUE,
                  y = t.lineHeight + "px",
                  w = this.$useSvgGutterIcons
                    ? "ace_gutter-cell_svg-icons "
                    : "ace_gutter-cell ",
                  b = this.$useSvgGutterIcons ? "ace_icon_svg" : "ace_icon",
                  $ = (f ? f.getText(s, o) : o + d).toString();
                if (
                  ...
                  this.$annotations[o] &&
                    o !== v &&
                    (w += this.$annotations[o].className),
                  m)
                ) {
                  var x = m[o];
                  null == x && (x = m[o] = s.getFoldWidget(o));
                }
                if (x) {
                  var C = "ace_fold-widget ace_" + x,
                    S = "start" == x && o == v && o < n.end.row;
                  if (S) {
                    C += " ace_closed";
                    for (var k = "", A = !1, L = o + 1; L <= n.end.row; L++)
                      if (this.$annotations[L]) {
                        if (" ace_error" === this.$annotations[L].className) {
                          (A = !0), (k = " ace_error_fold");
                          break;
                        }
                        " ace_warning" !== this.$annotations[L].className ||
                          ((A = !0), (k = " ace_warning_fold"));
                      }
                    w += k;
                  } else C += " ace_open";
                  c.className != C && (c.className = C),
                    i.setStyle(c.style, "height", y),
                    i.setStyle(c.style, "display", "inline-block"),
                    c.setAttribute("role", "button"),
                    c.setAttribute("tabindex", "-1");
                  var _ = s.getFoldWidgetRange(o);
                  _
                    ? c.setAttribute(
                        "aria-label",
                        l("Toggle code folding, rows $0 through $1", [
                          _.start.row + 1,
                          _.end.row + 1,
                        ]),
                      )
                    : n
                      ...
                      : c.setAttribute(
                          "aria-label",
                          l("Toggle code folding, row $0", [o + 1]),
                        ),
                    S
                      ? (c.setAttribute("aria-expanded", "false"),
                        c.setAttribute("title", l("Unfold code")))
                      : (c.setAttribute("aria-expanded", "true"),
                        c.setAttribute("title", l("Fold code")));
                } else
                  c &&
                    (i.setStyle(c.style, "display", "none"),
                    c.setAttribute("tabindex", "0"),
                    c.removeAttribute("role"),
                    c.removeAttribute("aria-label"));
                return (
                  A && this.$showFoldedAnnotations
                    ? ((h.className = "ace_gutter_annotation"),
                      (u.className = b),
                      (u.className += k),
                      i.setStyle(u.style, "height", y),
                      i.setStyle(h.style, "display", "block"),
                      i.setStyle(h.style, "height", y),
                      h.setAttribute(
                        "aria-label",
                        l("Read annotations row $0", [$]),
                      ),
                    ...
                    : this.$annotations[o]
                      ? ((h.className = "ace_gutter_annotation"),
                        ...
                        this.$useSvgGutterIcons
                          ? (u.className += this.$annotations[o].className)
                          : r.classList.add(
                              this.$annotations[o].className.replace(" ", ""),
                            ),
                        i.setStyle(u.style, "height", y),
                        i.setStyle(h.style, "display", "block"),
                        i.setStyle(h.style, "height", y),
                        ...
                        h.setAttribute("tabindex", "-1"),
                        h.setAttribute("role", "button"))
                      : (i.setStyle(h.style, "display", "none"),
                  ...
                  (e.text = $),
                  "none" === h.style.display && "none" === c.style.display
        ...
        function h(e) {
          ...
          return o.appendChild(r), e;
        }
        (c.prototype.$fixedWidth = !1),
          (c.prototype.$highlightGutterLine = !0),
          (c.prototype.$renderer = ""),
          (c.prototype.$showLineNumbers = !0),
          (c.prototype.$showFoldWidgets = !0),
          o.implement(c.prototype, s),
          (t.Gutter = c);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        var i = e("../range").Range,
          ...
          r = (function () {
            ...
            return (
                      ...
                      if (!o.isEmpty())
                        if (((o = o.toScreenRange(this.session)), i.renderer)) {
                          var r = this.$getTop(o.start.row, e),
                            s =
                              this.$padding + o.start.column * e.characterWidth;
                          i.renderer(t, o, s, r, e);
                        } else
                          "fullLine" == i.type
                            ? this.drawFullLineMarker(t, o, i.clazz, e)
                            : "screenLine" == i.type
                              ? this.drawScreenLineMarker(t, o, i.clazz, e)
                              : o.isMultiLine()
                                ? "text" == i.type
                                  ? this.drawTextMarker(t, o, i.clazz, e)
                                  : this.drawMultiLineMarker(t, o, i.clazz, e)
              ...
              (e.prototype.drawTextMarker = function (e, t, n, o, r) {
                for (
                  var s = this.session,
                    a = t.start.row,
                    l = t.end.row,
                    ...
                    h = 0,
                    u = 0,
                    d = s.getScreenLastRowColumn(c),
                    p = new i(c, t.start.column, c, u);
                  c <= l;
                  c++
                )
                  (p.start.row = p.end.row = c),
                    (p.start.column =
                      c == a ? t.start.column : s.getRowWrapIndent(c)),
                    (p.end.column = d),
                    (h = u),
                    (u = d),
                    (d =
                      c + 1 < l
                        ? s.getScreenLastRowColumn(c + 1)
                        : c == l
                          ? 0
                          : t.end.column),
                    this.drawSingleLineMarker(
              ...
              (e.prototype.drawMultiLineMarker = function (e, t, n, i, o) {
                var r = this.$padding,
                  s = i.lineHeight,
                ...
                if (
                  !((s = (t.end.row - t.start.row - 1) * i.lineHeight) <= 0)
                ) {
              ...
              (e.prototype.drawSingleLineMarker = function (e, t, n, i, o, r) {
                if (this.session.$bidiHandler.isBidiRow(t.start.row))
                  return this.drawBidiSingleLineMarker(e, t, n, i, o, r);
                var s = i.lineHeight,
                  a =
              ...
              (e.prototype.drawFullLineMarker = function (e, t, n, i, o) {
                var r = this.$getTop(t.start.row, i),
                  s = i.lineHeight;
                t.start.row != t.end.row &&
                  (s += this.$getTop(t.end.row, i) - r),
                  this.elt(
                    n,
                    "height:" +
                      s +
              ...
              (e.prototype.drawScreenLineMarker = function (e, t, n, i, o) {
                var r = this.$getTop(t.start.row, i),
                  s = i.lineHeight;
                this.elt(
                  n,
        ...
        (r.prototype.$padding = 0), (t.Marker = r);
      },
    ),
    ace.define(
      "ace/layer/text_util",
    ...
    ace.define(
      ...
      function (e, t, n) {
            ...
            return (
              ...
              (e.prototype.$computeTabString = function () {
                ...
                for (var t = (this.$tabStrings = [0]), n = 1; n < e + 1; n++) {
                  if (this.showTabs)
                    ((i = this.dom.createElement("span")).className =
                      "ace_invisible ace_invisible_tab"),
                      (i.textContent = r.stringRepeat(this.TAB_CHAR, n)),
                      t.push(i);
                  else
                    t.push(
                ...
                if (this.displayIndentGuides) {
                  ...
                  var i,
                    ...
                    c = this.showTabs
                      ? r.stringRepeat(this.TAB_CHAR, this.tabSize)
                      : a;
                  ((i = this.dom.createElement("span")).className = o + s),
                    (i.textContent = a),
                    (this.$tabStrings[" "] = i),
                    ((i = this.dom.createElement("span")).className = o + l),
                    (i.textContent = c),
                    (this.$tabStrings["\t"] = i);
                }
              }),
              (e.prototype.updateLines = function (e, t, n) {
                ...
                for (
                  ...
                  a > h &&
                    ((a = l.end.row + 1),
                    (h = (l = this.session.getNextFoldLine(a, l))
                      ? l.start.row
                      : 1 / 0)),
                    !(a > o);
              ...
              (e.prototype.scrollLines = function (e) {
                ...
                if (t.lastRow > e.lastRow)
                  for (
                    o = this.session.getFoldedRowCount(
                      e.lastRow + 1,
                      t.lastRow,
                    );
                    o > 0;
              ...
              (e.prototype.$renderLinesFragment = function (e, t, n) {
                for (
                  ...
                  r > a &&
                    ((r = s.end.row + 1),
                    (a = (s = this.session.getNextFoldLine(r, s))
                      ? s.start.row
                      : 1 / 0)),
                    !(r > n);
                  ...
                  this.dom.removeChildren(c),
                    o.setStyle(
                      c.style,
                      "height",
                      this.$lines.computeLineHeight(r, e, this.session) + "px",
                    ),
                    o.setStyle(
                      c.style,
                      "top",
                      this.$lines.computeLineTop(r, e, this.session) + "px",
                    ),
                    this.$renderLine(c, r, r == a && s),
                    this.$useLineGroups()
              ...
              (e.prototype.update = function (e) {
                ...
                for (
                  var t = e.firstRow, n = e.lastRow, i = this.$lines;
                  i.getLength();
              ...
              (e.prototype.$renderToken = function (e, t, n, i) {
                for (
                  var o,
                    s = this,
                    a =
                      /(\t)|( +)|([\x00-\x1f\x80-\xa0\xad\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\uFEFF\uFFF9-\uFFFC\u2066\u2067\u2068\u202A\u202B\u202D\u202E\u202C\u2069]+)|(\u3000)|([\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3001-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]|[\uD800-\uDBFF][\uDC00-\uDFFF])/g,
                    h = this.dom.createFragment(this.element),
                    u = 0;
                  (o = a.exec(i));
                  ...
                  var d = o[1],
                    ...
                    m = o[5];
                  if (s.showSpaces || !p) {
                    var v = u != o.index ? i.slice(u, o.index) : "";
                    if (
                      ((u = o.index + o[0].length),
                      v &&
                        h.appendChild(this.dom.createTextNode(v, this.element)),
                      d)
                    ) {
                      var y = s.session.getScreenTabSize(t + o.index);
                      h.appendChild(s.$tabStrings[y].cloneNode(!0)),
                        (t += y - 1);
                    } else if (p) {
                      if (s.showSpaces)
                        ((b = this.dom.createElement("span")).className =
                          "ace_invisible ace_invisible_space"),
                          (b.textContent = r.stringRepeat(
                            s.SPACE_CHAR,
                            p.length,
                          )),
                          h.appendChild(b);
                      ...
                      (t += 1),
                        ((b = this.dom.createElement("span")).style.width =
                          2 * s.config.characterWidth + "px"),
                        (b.className = s.showSpaces
                          ? "ace_cjk ace_invisible ace_invisible_space"
                          : "ace_cjk"),
                        (b.textContent = s.showSpaces ? s.SPACE_CHAR : f),
                        h.appendChild(b);
                    } else if (m) {
                      (t += 1),
                        ((b = this.dom.createElement("span")).style.width =
                ...
                if (
                  (h.appendChild(
                    this.dom.createTextNode(u ? i.slice(u) : i, this.element),
                  ),
                  c(n.type))
                )
                  e.appendChild(h);
                  ...
                  "fold" == n.type &&
                    ...
                    b.setAttribute("title", l("Unfold code"))),
                    (b.className = w),
                    b.appendChild(h),
                    e.appendChild(b);
                }
              ...
              (e.prototype.renderIndentGuide = function (e, t, n) {
                ...
                if (" " == t[0]) {
                  for (
                    var o = (i -= i % this.tabSize) / this.tabSize, r = 0;
                    r < o;
                    r++
                  )
                ...
                if (this.$highlightIndentGuides && this.displayIndentGuides) {
                  ...
                  if (e) {
                    var t = this.session.selection.getCursor(),
                      n = /^\s*/.exec(this.session.doc.getLine(t.row))[0]
                        .length,
                    ...
                    if (
                      ...
                      for (
                        var o = this.session.$bracketHighlight.ranges, r = 0;
                        r < o.length;
                        r++
                      )
                    ...
                    if (
                      ...
                      for (r = t.row + 1; r < e.length; r++) {
                        ...
                        if (
                          "" !== s &&
                          ((this.$highlightIndentGuideMarker.end = r), a <= n)
                        )
                          break;
                      }
                    }
                ...
                for (var e = this.$lines.cells, t = 0; t < e.length; t++) {
                  ...
                  if (n.length > 0)
                    for (var i = 0; i < n.length; i++)
                      if (
                        n[i].classList &&
                        n[i].classList.contains("ace_indent-guide-active")
                      ) {
              ...
              (e.prototype.$renderWrappedLine = function (e, t, n) {
                ...
                for (var c = 0; c < t.length; c++) {
                  ...
                  if (0 == c && this.displayIndentGuides) {
                    if (
                      ((i = u.length), !(u = this.renderIndentGuide(l, u, s)))
                    )
                      continue;
                    i -= u.length;
                  }
                  if (i + u.length < s)
                    (a = this.$renderToken(l, a, h, u)), (i += u.length);
                  else {
                    for (; i + u.length >= s; )
                      (a = this.$renderToken(l, a, h, u.substring(0, s - i))),
                        (u = u.substring(s - i)),
                        (i = s),
                        (l = this.$createLineElement()),
                        e.appendChild(l),
                        l.appendChild(
                          this.dom.createTextNode(
                            r.stringRepeat(" ", n.indent),
                            this.element,
                          ),
                        ),
                        (a = 0),
                        (s = n[++o] || Number.MAX_VALUE);
                    0 != u.length &&
                      ((i += u.length), (a = this.$renderToken(l, a, h, u)));
                  }
                }
              ...
              (e.prototype.$renderOverflowMessage = function (e, t, n, i, o) {
                n &&
                  this.$renderToken(
                    e,
                    t,
                    n,
                    i.slice(0, this.MAX_LINE_LENGTH - t),
                  );
                var r = this.dom.createElement("span");
                (r.className = "ace_inline_button ace_keyword ace_toggle_wrap"),
                  (r.textContent = o ? "<hide>" : "<click to see more...>"),
                  e.appendChild(r);
              }),
              (e.prototype.$renderLine = function (e, t, n) {
                if ((n || 0 == n || (n = this.session.getFoldLine(t)), n))
                  var i = this.$getFoldLineTokens(t, n);
                else i = this.session.getTokens(t);
                var o = e;
                if (i.length) {
                  var r = this.session.getRowSplitData(t);
                  if (r && r.length) {
                    this.$renderWrappedLine(e, i, r);
                    o = e.lastChild;
                  } else {
                    o = e;
                    this.$useLineGroups() &&
                      ((o = this.$createLineElement()), e.appendChild(o)),
                      this.$renderSimpleLine(o, i);
                  }
                } else
                  this.$useLineGroups() &&
                    ((o = this.$createLineElement()), e.appendChild(o));
              ...
              (e.prototype.$getFoldLineTokens = function (e, t) {
                ...
                return (
                  t.walk(
                    function (e, t, r, s, a) {
                      null != e
                        ? i.push({ type: "fold", value: e })
                        : (a && (o = n.getTokens(t)),
                          o.length &&
                            (function (e, t, n) {
                              for (
                                var o = 0, r = 0;
                                r + e[o].value.length < t;

                              )
                                if (((r += e[o].value.length), ++o == e.length))
                                  return;
                              for (
                                r != t &&
                                ((s = e[o].value.substring(t - r)).length >
                                  n - t && (s = s.substring(0, n - t)),
                                i.push({ type: e[o].type, value: s }),
                                (r = t + s.length),
                                (o += 1));
                                r < n && o < e.length;
        ...
        (h.prototype.EOF_CHAR = "¶"),
          (h.prototype.EOL_CHAR_LF = "¬"),
          (h.prototype.EOL_CHAR_CRLF = "¤"),
          (h.prototype.EOL_CHAR = h.prototype.EOL_CHAR_LF),
          (h.prototype.TAB_CHAR = "—"),
          (h.prototype.SPACE_CHAR = "·"),
          (h.prototype.$padding = 0),
          (h.prototype.MAX_LINE_LENGTH = 1e4),
          (h.prototype.showInvisibles = !1),
          (h.prototype.showSpaces = !1),
          (h.prototype.showTabs = !1),
          (h.prototype.showEOL = !1),
          (h.prototype.displayIndentGuides = !0),
          (h.prototype.$highlightIndentGuides = !0),
          (h.prototype.$tabStrings = []),
          (h.prototype.destroy = {}),
          (h.prototype.onChangeTabSize = h.prototype.$computeTabString),
          i.implement(h.prototype, a),
          (t.Text = h);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
            ...
            return (
              (e.prototype.$updateOpacity = function (e) {
                for (var t = this.cursors, n = t.length; n--; )
                  i.setStyle(t[n].style, "opacity", e ? "" : "0");
              }),
              ...
              (e.prototype.restartTimer = function () {
                ...
                if (
                  ...
                  this.smoothBlinking &&
                    ...
                    i.removeCssClass(this.element, "ace_smooth-blinking")),
                  e(!0),
              ...
              (e.prototype.update = function (e) {
                ...
                for (var r = t.length; n < r; n++) {
                  ...
                  if (!((s.top > e.height + e.offset || s.top < 0) && n > 1)) {
                    var a = this.cursors[o++] || this.addCursor(),
                      l = a.style;
                    this.drawCursor
                      ? this.drawCursor(a, s, e, t[n], this.session)
                      : this.isCursorInView(s, e)
                        ? (i.setStyle(l, "display", "block"),
                          i.translate(a, s.left, s.top),
                          i.setStyle(
                            l,
                            "width",
                            Math.round(e.characterWidth) + "px",
                          ),
                          i.setStyle(l, "height", e.lineHeight + "px"))
                        : i.setStyle(l, "display", "none");
                  }
                }
              ...
              (e.prototype.$setOverwrite = function (e) {
                e != this.overwrite &&
                  ((this.overwrite = e),
                  e
                    ? i.addCssClass(this.element, "ace_overwrite-cursors")
                    : i.removeCssClass(this.element, "ace_overwrite-cursors"));
              }),
              (e.prototype.destroy = function () {
        ...
        (o.prototype.$padding = 0),
          (o.prototype.drawCursor = null),
          (t.Cursor = o);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        ...
        var u = (function (e) {
          function t(t, n) {
            var i = e.call(this, t, "-v") || this;
            return (
              (i.scrollTop = 0),
              (i.scrollHeight = 0),
              (n.$scrollbarWidth = i.width = s.scrollbarWidth(t.ownerDocument)),
              (i.inner.style.width = i.element.style.width =
                (i.width || 15) + 5 + "px"),
              (i.$minWidth = 0),
              i
            );
          ...
          return (
            ...
            (t.prototype.onScroll = function () {
              if (!this.skipEvent) {
                if (
                  ((this.scrollTop = this.element.scrollTop), 1 != this.coeff)
                ) {
        ...
        var d = (function (e) {
          function t(t, n) {
            var i = e.call(this, t, "-h") || this;
            return (
              (i.scrollLeft = 0),
              (i.height = n.$scrollbarWidth),
              (i.inner.style.height = i.element.style.height =
                (i.height || 15) + 5 + "px"),
              i
            );
          }
    ...
    ace.define(
      ...
      function (e, t, n) {
              ...
              if ("mousedown" === e && 0 === a.getButton(t) && 2 !== t.detail) {
                if (t.target === this.inner) {
                  ...
                  var s = setInterval(function () {
                    if (void 0 !== i) {
                      var e = n.scrollTopFromThumbTop(r + i - o);
                      e !== n.scrollTop && n._emit("scroll", { data: e });
                    }
                  }, 20);
                  return a.preventDefault(t);
                }
                var l =
                  t.clientY -
                  ...
                  this.thumbHeight / 2;
                return (
                  this._emit("scroll", { data: this.scrollTopFromThumbTop(l) }),
                  a.preventDefault(t)
                );
              }
            }),
            ...
            (t.prototype.onMouseDown = function (e, t) {
              if ("mousedown" === e && 0 === a.getButton(t) && 2 !== t.detail) {
                if (t.target === this.inner) {
                  ...
                  var s = setInterval(function () {
                    if (void 0 !== i) {
                      var e = n.scrollLeftFromThumbLeft(r + i - o);
                ...
                return (
                  this._emit("scroll", {
                    data: this.scrollLeftFromThumbLeft(l),
                  }),
                  a.preventDefault(t)
                );
              }
        ...
        (u.prototype.setInnerWidth = u.prototype.setScrollWidth),
          (t.ScrollBar = h),
          (t.ScrollBarV = h),
          (t.ScrollBarH = u),
          (t.VScrollBar = h),
            ...
            return (
              (e.prototype.schedule = function (e) {
                (this.changes = this.changes | e),
                  this.changes &&
                    !this.pending &&
                    (i.nextFrame(this._flush), (this.pending = !0));
              }),
          ...
          d = (function () {
            function e(e) {
              (this.el = o.createElement("div")),
                ...
                (this.$measureNode.textContent = r.stringRepeat("X", c)),
            ...
            return (
              ...
              (e.prototype.$measureCharWidth = function (e) {
                return (
                  (this.$main.textContent = r.stringRepeat(e, c)),
                  this.$main.getBoundingClientRect().width / c
                );
              }),
              ...
              (e.prototype.transformCoordinates = function (e, t) {
                e && (e = r(1 / this.$getZoom(this.el), e));
                function n(e, t, n) {
                ...
                var a = s(this.els[0]),
                  ...
                  c = s(this.els[2]),
                  h = s(this.els[3]),
                  d = n(i(h, l), i(h, c), i(o(l, c), o(h, a))),
                  p = r(1 + d[0], i(l, a)),
                  g = r(1 + d[1], i(c, a));
                if (t) {
                  var f = t,
                    m = (d[0] * f[0]) / u + (d[1] * f[1]) / u + 1,
                    v = o(r(f[0], p), r(f[1], g));
                  return o(r(1 / m / u, v), a);
                }
                var y = i(e, a),
                  w = n(i(p, r(d[0], y)), i(g, r(d[1], y)), y);
                return r(u, w);
              }),
              e
            );
          })();
        (d.prototype.$characterSize = { width: 0, height: 0 }),
          i.implement(d.prototype, l),
          (t.FontMetrics = d);
      },
    ),
    ace.define(
          ...
          s = (function () {
            ...
            return (
              (e.prototype.$updateDecorators = function (e) {
                ...
                if (
                  (n.clearRect(0, 0, this.canvas.width, this.canvas.height), i)
                ) {
                  ...
                  for (
                    var r = this.renderer.session.$foldData, s = 0;
                    s < i.length;
                    s++
                  ) {
                    var a = i[s].row,
                      l = this.compensateFoldRows(a, r),
                      c = Math.round(
                        (a - l) * this.lineHeight * this.heightRatio,
                      ),
                      h = Math.round(
                        (a - l) * this.lineHeight * this.heightRatio,
                      ),
                      u = Math.round(
                        ((a - l) * this.lineHeight + this.lineHeight) *
                          this.heightRatio,
                      );
                    if (u - h < this.minDecorationHeight) {
                      var d = ((h + u) / 2) | 0;
                      d < this.halfMinDecorationHeight
                        ? (d = this.halfMinDecorationHeight)
                        : d + this.halfMinDecorationHeight >
                            this.canvasHeight &&
                          (d =
                            this.canvasHeight - this.halfMinDecorationHeight),
                        (h = Math.round(d - this.halfMinDecorationHeight)),
                        (u = Math.round(d + this.halfMinDecorationHeight));
                    }
                    (n.fillStyle = t[i[s].type] || null),
                      n.fillRect(0, c, this.canvasWidth, u - h);
                  }
                }
                var p = this.renderer.session.selection.getCursor();
                if (p) {
                  (l = this.compensateFoldRows(p.row, r)),
                    (c = Math.round(
                      (p.row - l) * this.lineHeight * this.heightRatio,
                    ));
                  (n.fillStyle = "rgba(0, 0, 0, 0.5)"),
                    n.fillRect(0, c, this.canvasWidth, 2);
                }
              }),
                ...
                if (t && t.length > 0)
                  for (var i = 0; i < t.length; i++)
                    e > t[i].start.row && e < t[i].end.row
                      ? (n += e - t[i].start.row)
                      : e >= t[i].end.row &&
                        (n += t[i].end.row - t[i].start.row);
                return n;
              }),
              e
            );
          })();
        o.implement(s.prototype, r), (t.Decorator = s);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        var i = e("./lib/oop"),
          ...
          y = e("./css/editor-css"),
          w = e("./layer/decorators").Decorator,
          b = e("./lib/useragent");
        o.importCssString(y, "ace_editor.css", !1);
        var $ = (function () {
          function e(e, t) {
            var n = this;
            (this.container = e || o.createElement("div")),
              o.addCssClass(this.container, "ace_editor"),
              o.HI_DPI && o.addCssClass(this.container, "ace_hidpi"),
              this.setTheme(t),
              null == s.get("useStrictCSP") && s.set("useStrictCSP", !1),
          ...
          return (
            ...
            (e.prototype.setSession = function (e) {
              this.session &&
                ...
                e &&
                  ...
                  (this.scrollBarH.scrollLeft = this.scrollBarV.scrollTop =
                    null),
                  (this.onChangeNewLineMode =
            ...
            (e.prototype.onResize = function (e, t, n, i) {
              if (!(this.resizing > 2)) {
                this.resizing > 0
                  ? this.resizing++
                  : (this.resizing = e ? 1 : 0);
            ...
            (e.prototype.$updateCachedSize = function (e, t, n, i) {
              ...
              if (
                (i &&
                  ...
                  this.scrollBarV.setHeight(s.scrollerHeight),
                ...
                (r |= this.CHANGE_SIZE),
                  ...
                  (this.gutterWidth = t),
                  o.setStyle(this.scrollBarH.element.style, "left", t + "px"),
                  o.setStyle(
                    this.scroller.style,
                    "left",
                ...
                o.setStyle(this.scrollBarH.element.style, "right", l),
                  o.setStyle(this.scroller.style, "right", l),
                  o.setStyle(
                    this.scroller.style,
                    "bottom",
                    this.scrollBarH.getHeight(),
                  ),
                  this.scrollBarH.setWidth(s.scrollerWidth),
                  ((this.session &&
                    this.session.getUseWrapMode() &&
              ...
              return (s.$dirty = !n || !i), r && this._signal("resize", a), r;
            }),
              ...
              if (!this.$isMousePressed) {
                ...
                if (this.$keepTextAreaAtCursor || t) {
                  ...
                  if (n) {
                    t &&
                      t.markerRange &&
                      (n = this.$cursorLayer.getPixelPosition(
                        t.markerRange.start,
                        !0,
                      ));
                    ...
                    r -= i.offset;
                    var a =
                      (t && t.useTextareaForIME) || b.isMobile
                        ? this.lineHeight
                        : 1;
                    if (r < 0 || r > i.height - a)
                      o.translate(this.textarea, 0, 0);
                    else {
                      var l = 1,
                        c = this.$size.height - a;
                      if (t)
                        if (t.useTextareaForIME) {
                          var h = this.textarea.value;
                          l =
                            this.characterWidth *
                            this.session.$getStringScreenWidth(h)[0];
                        } else r += this.lineHeight + 2;
                      else r += this.lineHeight;
                      (s -= this.scrollLeft) > this.$size.scrollerWidth - l &&
                        (s = this.$size.scrollerWidth - l),
                        (s += this.gutterWidth + this.margin.left),
                        o.setStyle(e, "height", a + "px"),
                        o.setStyle(e, "width", l + "px"),
                        o.translate(
                          this.textarea,
                          Math.min(s, this.$size.scrollerWidth - l),
                          Math.min(r, c),
                        );
                    }
                  }
                } else o.translate(this.textarea, -100, 0);
              }
            }),
            (e.prototype.getFirstVisibleRow = function () {
            ...
            (e.prototype.setScrollMargin = function (e, t, n, i) {
            ...
            (e.prototype.setMargin = function (e, t, n, i) {
              var o = this.margin;
              (o.top = 0 | e),
                (o.bottom = 0 | t),
                (o.right = 0 | i),
              ...
              if (
                ...
                if (
                  ...
                  (n = this.layerConfig),
                    ...
                    o.translate(this.content, -this.scrollLeft, -n.offset);
                  var r = n.width + 2 * this.$padding + "px",
                    s = n.minHeight + "px";
                  o.setStyle(this.content.style, "width", r),
                    o.setStyle(this.content.style, "height", s);
                }
                if (
                  (e & this.CHANGE_H_SCROLL &&
                    (o.translate(this.content, -this.scrollLeft, -n.offset),
            ...
            (e.prototype.$computeLayerConfig = function () {
              var e = this.session,
                ...
                r =
                  ...
                  (this.$hScrollBarAlwaysVisible ||
                    t.scrollerWidth - o - 2 * this.$padding < 0),
              ...
              this.session.setScrollTop(
                ...
                this.session.setScrollLeft(
                  Math.max(
                    ...
                    Math.min(
                      this.scrollLeft,
                      o + 2 * this.$padding - t.scrollerWidth + h.right,
                    ),
                  ),
                );
              var u =
              ...
              var p,
                g,
                f = this.scrollTop % this.lineHeight,
              ...
              b && (v = b.start.row),
                ...
                (g = e.getRowLength(v) * w),
                (y = Math.min(e.screenToDocumentRow(y, 0), e.getLength() - 1)),
                (l = t.scrollerHeight + e.getRowLength(y) * w + g),
                (f = this.scrollTop - p * w);
              var $ = 0;
              return (
                (this.layerConfig.width != o || s) &&
                ...
                this.session.$bidiHandler &&
                  this.session.$bidiHandler.setContentWidth(o - this.$padding),
                $
              );
            }),
                ...
                l + s > r
                  ...
                  : l + this.$size.scrollerHeight - a < r + this.lineHeight &&
                    (t &&
                      ...
                      (r += t * this.$size.scrollerHeight),
                    this.session.setScrollTop(
                      r + this.lineHeight + a - this.$size.scrollerHeight,
                    ));
                var c = this.scrollLeft,
                  h = 2 * this.layerConfig.characterWidth;
                o - h < c
                  ? ((o -= h) < this.$padding + h &&
                  ...
                  : ((o += h),
                    c + this.$size.scrollerWidth < o + this.characterWidth
                      ? this.session.setScrollLeft(
                          Math.round(
                            o + this.characterWidth - this.$size.scrollerWidth,
                          ),
                        )
                      : c <= this.$padding &&
            ...
            (e.prototype.animateScrolling = function (e, t) {
              ...
              if (this.$animatedScroll) {
                ...
                if (e != n) {
                  ...
                  (this.$scrollAnimation = { from: e, to: n, steps: r }),
                    clearInterval(this.$timer),
                    i.session.setScrollTop(r.shift()),
            ...
            (e.prototype.pixelToScreenCoordinates = function (e, t) {
              ...
              var o = e + this.scrollLeft - n.left - this.$padding,
                r = o / this.characterWidth,
            ...
            (e.prototype.screenToTextCoordinates = function (e, t) {
              ...
              var o = e + this.scrollLeft - n.left - this.$padding,
                r = o / this.characterWidth,
                s = this.$blockCursor ? Math.floor(r) : Math.round(r),
            ...
            (e.prototype.textToScreenCoordinates = function (e, t) {
              var n = this.scroller.getBoundingClientRect(),
                ...
                o =
                  this.$padding +
                  (this.session.$bidiHandler.isBidiRow(i.row, e)
            ...
            (e.prototype.setGhostText = function (e, t) {
              var n = this.session.selection.cursor,
                i = t || { row: n.row, column: n.column };
              this.removeGhostText();
              var o = e.split("\n");
              if (
                (this.addToken(o[0], "ghost_text", i.row, i.column),
                (this.$ghostText = {
                  text: e,
                ...
                var r = this.$cursorLayer.getPixelPosition(i, !0),
                  s = this.container.getBoundingClientRect().height,
                  a = o.length * this.lineHeight;
                if (a < s - r.top) return;
                a < s
                  ? this.scrollBy(0, (o.length - 1) * this.lineHeight)
                  : this.scrollBy(0, r.top);
              }
            }),
            (e.prototype.removeGhostText = function () {
              if (this.$ghostText) {
            ...
            (e.prototype.addToken = function (e, t, n, i) {
              var o = this.session;
                ...
                for (var a = 0, l = 0; l < s.length; l++) {
                  ...
                  if (i <= (a += c.value.length)) {
                    var h = c.value.length - (a - i),
                      u = c.value.slice(0, h),
                      d = c.value.slice(h);
                    s.splice(l, 1, { type: c.type, value: u }, r, {
                      type: c.type,
                      value: d,
                    });
                    break;
            ...
            (e.prototype.setTheme = function (e, t) {
              ...
              function r(i) {
                ...
                i.$id && (n.$themeId = i.$id),
                  o.importCssString(i.cssText, i.cssClass, n.container),
              ...
              (this.$horizScroll = this.$vScroll = null),
                ...
                !0 === e
                  ? ((this.scrollBarV = new g(this.container, this)),
                    ...
                    (this.$scrollDecorator = new w(this.scrollBarV, this)),
            ...
            (e.prototype.$addResizeObserver = function () {
              if (window.ResizeObserver && !this.$resizeObserver) {
                var e = this;
                (this.$resizeTimer = r.delayedCall(function () {
                  ...
                  (this.$resizeObserver = new window.ResizeObserver(function (
                    ...
                    var n = t[0].contentRect.width,
                      i = t[0].contentRect.height;
                    Math.abs(e.$size.width - n) > 1 ||
                    Math.abs(e.$size.height - i) > 1
                      ? e.$resizeTimer.delay()
        ...
        ($.prototype.CHANGE_CURSOR = 1),
          ($.prototype.CHANGE_MARKER = 2),
          ($.prototype.CHANGE_GUTTER = 4),
          ($.prototype.CHANGE_SCROLL = 8),
          ($.prototype.CHANGE_LINES = 16),
          ($.prototype.CHANGE_TEXT = 32),
          ($.prototype.CHANGE_SIZE = 64),
          ($.prototype.CHANGE_MARKER_BACK = 128),
          ($.prototype.CHANGE_MARKER_FRONT = 256),
          ($.prototype.CHANGE_FULL = 512),
          ($.prototype.CHANGE_H_SCROLL = 1024),
          ($.prototype.$changes = 0),
          ($.prototype.$padding = null),
          ($.prototype.$frozen = !1),
          ($.prototype.STEPS = 8),
          i.implement($.prototype, v),
          s.defineOptions($.prototype, "renderer", {
            useResizeObserver: {
              set: function (e) {
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        (function () {
          i.implement(this, r),
            (this.$createWorkerFromOldConfig = function (t, n, i, o, r) {
              if (
                (e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl),
                s.get("packaged") || !e.toUrl)
              )
                o = o || s.moduleUrl(n, "worker");
              else {
    ...
    ace.define(
      ...
      function (e, t, n) {
          ...
          s = (function () {
            ...
            return (
              (e.prototype.setup = function () {
                ...
                (o.$insertRight = !0),
                  o.detach(),
                  (o.markerId = n.addMarker(
                    new i(o.row, o.column, o.row, o.column + this.length),
                    this.mainClass,
                    null,
                    !1,
                  )),
                  ...
                  (this.othersActive = !0),
                    this.others.forEach(function (n) {
                      n.markerId = e.addMarker(
                        new i(n.row, n.column, n.row, n.column + t.length),
                        t.othersClass,
                        null,
                        !1,
                      );
                  ...
                  if (
                    ...
                    if ("insert" === e.action)
                      ...
                      for (s = this.others.length - 1; s >= 0; s--) {
                        ...
                        this.doc.remove(
                          new i(a.row, a.column, a.row, a.column - n),
                        );
                      }
              ...
              (e.prototype.updateMarkers = function () {
                if (!this.$updating) {
                    ...
                    n = function (n, o) {
                      t.removeMarker(n.markerId),
                        (n.markerId = t.addMarker(
                          new i(n.row, n.column, n.row, n.column + e.length),
                          o,
                          null,
                          !1,
                        ));
                  ...
                  for (var o = this.others.length; o--; )
                    n(this.others[o], this.othersClass);
                }
              }),
        ...
        r.implement(s.prototype, o), (t.PlaceHolder = s);
      },
    ),
    ace.define(
          ...
          if (
            ...
            if (0 === c) {
              var h,
                u = e.editor,
                d = u.selection,
                p = u.inMultiSelectMode,
                g = e.getDocumentPosition(),
                f = d.getCursor(),
                m = e.inSelection() || (d.isEmpty() && r(g, f)),
                v = e.x,
                y = e.y,
                w = u.session,
                b = u.renderer.pixelToScreenCoordinates(v, y),
                $ = b;
              if (u.$mouseHandler.$enableJumpToDef)
                (a && n) || (l && n)
                  ? (h = s ? "block" : "add")
                  : n && u.$blockSelectEnabled && (h = "block");
              else if (l && !n) {
                if (((h = "add"), !p && s)) return;
              ...
              if (
                ...
                var k = [],
                  A = function () {
                    var e = u.renderer.pixelToScreenCoordinates(v, y),
                      t = w.screenToDocumentPosition(
                        e.row,
                        e.column,
                        e.offsetX,
                      );
                ...
                p && !l
                  ...
                  : !p &&
                    l &&
                    ((S = d.toOrientedRange()), u.addSelectionMarker(S)),
                  s
                    ? (b = w.documentToScreenPosition(d.lead))
                    : d.moveToPosition(g),
                  ($ = { row: -1, column: -1 });
                var L = A;
                i.capture(
                  ...
                  function (e) {
                    A(),
                      ...
                      S && (u.removeSelectionMarker(S), d.toSingleRange(S));
            ...
            (this.ranges = null),
              ...
              (this.splitIntoLines = function () {
                for (
                  ...
                  if (r === s) t.push(i.clone());
                    ...
                    t.push(new o(s, 0, s, i.end.column));
                  }
              ...
              (this.joinSelections = function () {
                var e = this.rangeList.ranges,
                  t = e[e.length - 1],
                  n = o.fromPoints(e[0].start, t.end);
                this.toSingleRange(),
              ...
              (this.rectangularRangeBlock = function (e, t, n) {
                ...
                s < 0 && (s = 0), g < 0 && (g = 0), g == f && (n = !0);
                for (var m = g; m <= f; m++) {
                  var v = o.fromPoints(
                    this.session.screenToDocumentPosition(m, s, l),
                    this.session.screenToDocumentPosition(m, a, c),
                  );
                  if (v.isEmpty()) {
                    if (
                      h &&
                      ((u = v.end),
                      (d = h),
                      u.row == d.row && u.column == d.column)
                    )
                      break;
                    h = v.end;
                  }
                  (v.cursor = r ? v.start : v.end), i.push(v);
                }
                if ((p && i.reverse(), !n)) {
                  for (var y = i.length - 1; i[y].isEmpty() && y > 0; ) y--;
                  if (y > 0) for (var w = 0; i[w].isEmpty(); ) w++;
                  for (var b = y; b >= w; b--) i[b].isEmpty() && i.splice(b, 1);
                }
                return i;
              });
          }.call(r.prototype);
          ...
          e.$multiselectOnSessionChange ||
            ...
            (function (e) {
              ...
              a.addListener(
                ...
                function (t) {
                  var o =
                    18 == t.keyCode && !(t.ctrlKey || t.shiftKey || t.metaKey);
                  e.$blockSelectEnabled && o
                    ? n || (e.renderer.setMouseCursor("crosshair"), (n = !0))
                    : n && i();
                },
                e,
              ),
                a.addListener(t, "keyup", i, e),
                a.addListener(t, "blur", i, e);
            })(e));
        }
        (function () {
          (this.updateSelectionMarkers = function () {
            ...
            (this.removeSelectionMarkers = function (e) {
              for (
                var t = this.session.$selectionMarkers, n = e.length;
                n--;
              ...
              if (n.multiSelect) {
                if (t.multiSelectAction)
                  "forEach" == t.multiSelectAction
                    ? (i = n.forEachSelection(t, e.args))
                    : "forEachLine" == t.multiSelectAction
                      ? (i = n.forEachSelection(t, e.args, !0))
                      : "single" == t.multiSelectAction
                        ? (n.exitMultiSelectMode(),
                          (i = t.exec(n, e.args || {})))
                        : (i = t.multiSelectAction(n, e.args || {}));
                else {
            ...
            (this.forEachSelection = function (e, t, n) {
              if (!this.inVirtualSelectionMode) {
                ...
                for (var p = h.length; p--; ) {
                  if (s)
                    for (; p > 0 && h[p].start.row == h[p - 1].end.row; ) p--;
                  d.fromOrientedRange(h[p]),
                    (d.index = p),
                    (this.selection = a.selection = d);
                  var g = e.exec ? e.exec(this, t || {}) : e(this, t || {});
                  i || void 0 === g || (i = g), d.toOrientedRange(h[p]);
                }
                d.detach(),
            ...
            (this.getSelectedText = function () {
              ...
              if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
                for (
                  var t = this.multiSelect.rangeList.ranges, n = [], i = 0;
                  i < t.length;
                  i++
                )
              ...
              if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
                ...
                var i =
                  t == this.multiSelect.anchor
                    ...
                    : n.cursor;
                i.row != t.row ||
                this.session.$clipPositionToDocument(i.row, i.column).column !=
                  t.column
                  ? this.multiSelect.toSingleRange(
            ...
            (this.findAll = function (e, t, n) {
              ...
              return (
                i && r.rangeList.rangeAtPoint(i.start) && r.addRange(i, !0),
                o.length
              );
            }),
            (this.selectMoreLines = function (e, t) {
              ...
              i
                ? ((s = o.fromPoints(a, c)).cursor = s.start)
                : ((s = o.fromPoints(c, a)).cursor = s.end);
              if (
                ((s.desiredColumn = r.column), this.selection.inMultiSelectMode)
              ) {
                if (t) var h = n.cursor;
            ...
            (this.transposeSelections = function (e) {
              ...
              for (o = i.length; o--; ) {
                var l = (a = i[o]).clone();
                t.replace(a, s[o]),
                  (a.start.row = l.start.row),
                  (a.start.column = l.start.column);
              }
            ...
            (this.selectMore = function (e, t, n) {
              ...
              if (
                !o.isEmpty() ||
                (((o = i.getWordRange(o.start.row, o.start.column)).cursor =
                  -1 == e ? o.start : o.end),
              ...
              if (n.length && r.length != n.length - 1) {
                ...
                n.forEach(function (t, n) {
                  var i = t.cursor,
                    ...
                    h = c[n] - a;
                  r > h
                    ? e.insert(i, l.stringRepeat(" ", r - h))
                    : e.remove(new o(i.row, i.column, i.row, i.column - r + h)),
                    (t.start.column = t.end.column = s),
                ...
                (m = this.$reAlignText(m, p)),
                  ...
                  p ||
                    ((h.start.column = 0),
                    (h.end.column = m[m.length - 1].length)),
                  ...
                  return t
                    ? null == n
                      ? ((n = t[1].length),
                        ...
                        (o = t[3].length),
                        t)
                      : (n + i + o != t[1].length + t[2].length + t[3].length &&
                          (s = !1),
                        n != t[1].length && (r = !1),
                        n > t[1].length && (n = t[1].length),
                        i < t[2].length && (i = t[2].length),
          ...
          e("./config").defineOptions(d.prototype, "editor", {
            enableMultiselect: {
              set: function (e) {
                p(this), e ? this.on("mousedown", s) : this.off("mousedown", s);
              },
              value: !0,
            },
            enableBlockSelect: {
        ...
        (function () {
          (this.foldingStartMarker = null),
            ...
            (this.indentationBlock = function (e, t, n) {
              ...
              if (-1 != s) {
                for (
                  var a = n || r.length, l = e.getLength(), c = t, h = t;
                  ++t < l;
                ...
                if (h > c) {
                  var p = e.getLine(h).length;
                  return new i(c, a, h, p);
                }
              }
            }),
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        (t.showErrorMarker = function (e, t) {
          var n = e.session;
          n.widgetManager ||
            ((n.widgetManager = new i(n)), n.widgetManager.attach(e));
          var a = e.getCursorPosition(),
            l = a.row,
            c = n.widgetManager.getWidgetsAtRow(l).filter(function (e) {
          ...
          if (u) {
            var d = u[0];
            (a.column =
              (d.pos && "number" != typeof d.column ? d.pos.sc : d.column) ||
              0),
              (a.row = d.row),
              (h = e.renderer.$gutterLayer.$annotations[a.row]);
          } else {
            if (c) return;
            h = { text: [s("Looks good!")], className: "ace_ok" };
          }
          ...
          var p = {
            ...
            g = p.el.appendChild(o.createElement("div")),
            f = p.el.appendChild(o.createElement("div"));
        ...
        e("./worker/worker_client"),
          ...
          (t.edit = function (e, n) {
            ...
            var c = t.createEditSession(s),
              h = new r(new l(e), c, n),
              u = { document: c, editor: h, onResize: h.resize.bind(h, null) };
            return (
              a && (u.textarea = a),
    ...
    ace.require(["ace/ace"], function (e) {
      ...
      for (var n in (t || "undefined" == typeof window || (t = window),
      t || "undefined" == typeof self || (t = self),
      t.ace || (t.ace = e),
      e))
        e.hasOwnProperty(n) && (t.ace[n] = e[n]);
      (t.ace.default = t.ace),
        "object" == typeof module &&
          "object" == typeof exports &&
          module &&
          (module.exports = t.ace);
    }),
    ace.define(
    ...
    ace.require(["ace/theme/monokai"], function (e) {
      "object" == typeof module &&
        "object" == typeof exports &&
        module &&
        (module.exports = e);
    ...
    ace.define(
      ...
      function (e, t, n) {
        ...
        i.inherits(r, o),
          ...
          (t.JsDocCommentHighlightRules = r);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
              ...
              onMatch: function (e, t, n) {
                ...
                return (
                  ...
                  [
                    ...
                    { type: "meta.tag.tag-name.xml", value: e.substr(i) },
                  ]
                );
              },
              regex: "</?" + e,
        ...
        i.inherits(a, r), (t.JavaScriptHighlightRules = a);
      },
    ),
    ace.define(
      ...
      function (e, t, n) {
        ...
        function o(e, t, n) {
          ...
          for (-1 == t && r--; s[r]; ) {
            ...
            if (/w[s_oW]|_[sWo]|o[s_wW]|s[W]|W[so]/.test(l)) break;
          }
          function c(e) {
            return e
              ? /\s/.test(e)
          ...
          -1 == t && r++,
            n ? e.selection.moveCursorTo(o, r) : e.selection.moveTo(o, r);
        }
        (t.handler = new i()),
          t.handler.addCommands([
            ...
            },
            {
              ...
              exec: function (e) {
                e.selection.isEmpty() && e.selection.selectWord(),
                  e.findPrevious();
              },
              readOnly: !0,
            },
          ...
          [
            ...
            n && (n.bindKey = e.bindKey),
              t.handler.bindKey(e.bindKey, n || e.name);
          });
      },
    ),
    ace.require(["ace/keyboard/sublime"], function (e) {
      "object" == typeof module &&
        "object" == typeof exports &&
        module &&
        (module.exports = e);
  ...
  function T() {
    !(function () {
      Array.from(document.querySelectorAll(".output")).forEach((e) =>
        e.remove(),
      );
      for (let e of document.querySelectorAll(".tabbed-interface"))
        e.querySelector(".selected") || H(e.querySelector(".tab-btn"));
    })();
    let e,
      t,
      n = y.value,
      i = 0;
    for (; n !== (e = ejs.render(n)); ++i, n = e)
      t = z(w, `jxl_${i + 1}.ejs`, e, { type: "editor", readonly: !1 });
    return (
      t && (t.button.textContent = t.button.textContent.replace(/\.ejs$/, "")),
      {
        jxltree: e,
        tab: t ?? {
  ...
  async function I() {
    (b.disabled = !0), (C.innerHTML = "");
    try {
      let e = T().jxltree;
      await (async function (e) {
        let n;
        try {
          ({ jxlData: E, imageData: n } = await t.process(e)),
          ...
          M(
            `${e}\n\nStack:\n    ${e.stack.split("\n").join("\n    ")}\n${null != e.cause ? JSON.stringify(e.cause, null, 4) : ""}`,
          );
        }
      })(e);
    } catch (e) {
  ...
  function O(e) {
    "Enter" === e.code && e.ctrlKey && I();
  }
  (x.onclick = async (t) => {
    t.preventDefault();
    const { default: n } = await e("./deflate-BWM7g5_r"),
      i = btoa(n(y.value, 9)),
      o = new URLSearchParams({ payload: i });
    location.href = `/publish.html?${o.toString()}`;
  }),
    (b.onclick = I),
    ($.onclick = async () => {
      const t = new URL(location),
        n = new URLSearchParams(t.search),
        { default: i } = await e("./deflate-BWM7g5_r"),
        o = btoa(i(y.value, 9))
          .replaceAll("+", "-")
          .replaceAll("/", "_")
          .replaceAll("=", "");
      n.set("zcode", o),
        ...
        M("URL copied to clipboard.");
    }),
    (k.onclick = () => {
      if (!E) return;
      const e = new Blob([E], { type: "image/jxl" }),
        t = URL.createObjectURL(e),
        n = document.createElement("a");
      (n.href = t), (n.download = "art.jxl"), n.click();
    }),
    (_.onclick = async () => {
      let e = T();
      W.get(e.tab.content.querySelector("pre.editor")).setValue(
        await t.api.prettier(e.jxltree),
        -1,
      ),
        H(e.tab.button);
    }),
    (A.onclick = async () => {
      const e = await new Promise((e) => S.toBlob(e, "image/png")),
        t = URL.createObjectURL(e),
        n = document.createElement("a");
      (n.href = t), (n.download = "art.png"), n.click();
    }),
    (L.onchange = () => {
      S.classList.toggle("pixelated", L.scale > 1);
    });
  let D = 0,
    W = new WeakMap();
  function N(e, t = "javascript") {
    e.id || (e.id = "editor" + D);
    let n = ace.edit(e.id);
    return (
      W.set(e, n),
      n.setOptions({ fontSize: "13pt", wrap: !1, fixedWidthGutter: !0 }),
      n.setKeyboardHandler("ace/keyboard/sublime"),
      n.setTheme("ace/theme/monokai"),
      n.session.setMode(`ace/mode/${t}`),
      n.session.setTabSize(2),
      ++D,
      n
    );
  }
  function H(e) {
    let t = e.closest(".tabbed-interface");
    for (let e of t.querySelectorAll(".tab-btn"))
      e.classList.remove("selected");
    for (let e of t.querySelectorAll(".tab-content")) e.classList.add("hidden");
    e.classList.add("selected");
    let n = "#tab-content-" + e.id.slice(8);
    t.querySelector(n)?.classList.remove("hidden");
  }
  function B(e, t, n) {
    let i;
    (i = document.createElement("div")),
      i.classList.add("tab-btn", "output"),
      (i.id = `tab-btn-${t}`),
      (i.textContent = n),
      i.addEventListener("click", (e) => H(e.target));
    let o = e.querySelector(".tab-bar");
    return o.insertBefore(i, o.querySelector(".tab-bar-separator")), i;
  }
  function P(e, t, n, i) {
    let o = `tab-content-${t}`,
    ...
    if (
      (r ||
        ...
        r.classList.add("tab-content", "output", "hidden"),
        (r.id = o),
        e.appendChild(r)),
      "editor" == i.type)
    ) {
      let e = (function () {
        ...
        return e.classList.add("editor"), e;
      })();
      r.appendChild(e), N(e, "javascript").setValue(n, -1);
    }
    return r;
  }
  function z(e, t, n, i = {}) {
    let o = t.replaceAll(/[^-_a-zA-Z0-9]/g, "");
    return { button: B(e, o, t), content: P(e, o, n, i) };
  }
  const V = "source";
  !(async function () {
    for (let e of document.querySelectorAll(".tab-btn"))
      e.addEventListener("click", (e) => {
        H(e.target);
      });
    for (let e of document.querySelectorAll("pre.editor")) N(e, "javascript");
    ...
    let o = "",
      r = !1;
    if (i.has("zcode")) {
      const e = i.get("zcode").replaceAll("-", "+").replaceAll("_", "/");
      (o = t.inflate(atob(e))), (r = !0);
    } else
      i.has("code")
        ? ((o = atob(i.get("code").replaceAll("-", "+").replaceAll("_", "/"))),
          (r = !0))
        : (o = await t.get(V));
    o && (y.value = o),
      n.on("change", F),
    ...
    const s = L.getBoundingClientRect(),
      a = Math.min(s.width, s.height) / 1024;
    L.scaleTo(a.toFixed(2));
  })(),
    t.idle().then(() => e("./sw-installer-Ss1VIsNn"));
});
